...
80100046:	e8 e0 3b 00 00       	call   80103c2b <acquire>
...
8010007c:	e8 0f 3c 00 00       	call   80103c90 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 8b 39 00 00       	call   80103a17 <acquiresleep>
      return b;
...
801000ca:	e8 c1 3b 00 00       	call   80103c90 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 3d 39 00 00       	call   80103a17 <acquiresleep>
      return b;
...
80100105:	e8 e5 39 00 00       	call   80103aef <initlock>
...
80100143:	e8 9c 38 00 00       	call   801039e4 <initsleeplock>
...
801001a8:	e8 f4 38 00 00       	call   80103aa1 <holdingsleep>
...
801001e4:	e8 b8 38 00 00       	call   80103aa1 <holdingsleep>
...
801001f4:	e8 6d 38 00 00       	call   80103a66 <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 c0 a5 10 80 	movl   $0x8010a5c0,(%esp)
80100200:	e8 26 3a 00 00       	call   80103c2b <acquire>
  b->refcnt--;
...
8010024c:	e8 3f 3a 00 00       	call   80103c90 <release>
}
...
8010028a:	e8 9c 39 00 00       	call   80103c2b <acquire>
  while(n > 0){
...
801002d1:	e8 ba 39 00 00       	call   80103c90 <release>
        ilock(ip);
...
80100331:	e8 5a 39 00 00       	call   80103c90 <release>
  ilock(ip);
...
80100373:	e8 93 02 00 00       	call   8010060b <cprintf>
  cprintf("\n");
80100378:	c7 04 24 27 6f 10 80 	movl   $0x80106f27,(%esp)
...
8010038f:	e8 76 37 00 00       	call   80103b0a <getcallerpcs>
  for(i=0; i<10; i++)
...
801004ba:	e8 93 38 00 00       	call   80103d52 <memmove>
    pos -= 80;
...
801004d9:	e8 f9 37 00 00       	call   80103cd7 <memset>
...
80100506:	e8 75 4c 00 00       	call   80105180 <uartputc>
...
8010051f:	e8 5c 4c 00 00       	call   80105180 <uartputc>
80100524:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010052b:	e8 50 4c 00 00       	call   80105180 <uartputc>
80100530:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100537:	e8 44 4c 00 00       	call   80105180 <uartputc>
...
801005ca:	e8 5c 36 00 00       	call   80103c2b <acquire>
  for(i = 0; i < n; i++)
...
801005f1:	e8 9a 36 00 00       	call   80103c90 <release>
  ilock(ip);
...
80100638:	e8 ee 35 00 00       	call   80103c2b <acquire>
...
80100734:	e8 57 35 00 00       	call   80103c90 <release>
...
8010074f:	e8 d7 34 00 00       	call   80103c2b <acquire>
  while((c = getc()) >= 0){
...
80100873:	e8 18 34 00 00       	call   80103c90 <release>
  if(doprocdump) {
...
8010089e:	e8 4c 32 00 00       	call   80103aef <initlock>
...
80100970:	75 b2                	jne    80100924 <exec+0x52>
  if((pgdir = setupkvm()) == 0)
80100972:	e8 c9 59 00 00       	call   80106340 <setupkvm>
...
80100a06:	e8 db 57 00 00       	call   801061e6 <allocuvm>
...
80100a38:	e8 77 56 00 00       	call   801060b4 <loaduvm>
...
80100a74:	e8 6d 57 00 00       	call   801061e6 <allocuvm>
...
80100a9d:	e8 2e 58 00 00       	call   801062d0 <freevm>
...
80100abc:	e8 04 59 00 00       	call   801063c5 <clearpteu>
...
80100ae2:	e8 92 33 00 00       	call   80103e79 <strlen>
...
80100af4:	e8 80 33 00 00       	call   80103e79 <strlen>
80100af9:	83 c0 01             	add    $0x1,%eax
80100afc:	50                   	push   %eax
80100afd:	ff 36                	pushl  (%esi)
80100aff:	57                   	push   %edi
80100b00:	ff b5 ec fe ff ff    	pushl  -0x114(%ebp)
80100b06:	e8 08 5a 00 00       	call   80106513 <copyout>
...
80100b66:	e8 a8 59 00 00       	call   80106513 <copyout>
...
80100ba3:	e8 96 32 00 00       	call   80103e3e <safestrcpy>
...
80100bd1:	e8 5d 53 00 00       	call   80105f33 <switchuvm>
  freevm(oldpgdir);
80100bd6:	89 1c 24             	mov    %ebx,(%esp)
80100bd9:	e8 f2 56 00 00       	call   801062d0 <freevm>
  return 0;
...
80100c23:	e8 c7 2e 00 00       	call   80103aef <initlock>
}
...
80100c39:	e8 ed 2f 00 00       	call   80103c2b <acquire>
...
80100c68:	e8 23 30 00 00       	call   80103c90 <release>
      return f;
...
80100c7f:	e8 0c 30 00 00       	call   80103c90 <release>
  return 0;
...
80100c9d:	e8 89 2f 00 00       	call   80103c2b <acquire>
  if(f->ref < 1)
...
80100cba:	e8 d1 2f 00 00       	call   80103c90 <release>
  return f;
}
...
80100ce2:	e8 44 2f 00 00       	call   80103c2b <acquire>
  if(f->ref < 1)
...
80100d03:	e8 88 2f 00 00       	call   80103c90 <release>
    return;
...
80100d49:	e8 42 2f 00 00       	call   80103c90 <release>
  if(ff.type == FD_PIPE)
...
80100f8a:	e8 c3 2d 00 00       	call   80103d52 <memmove>
...
80100f9a:	e8 b3 2d 00 00       	call   80103d52 <memmove>
    name[len] = 0;
...
80100fdf:	e8 f3 2c 00 00       	call   80103cd7 <memset>
  log_write(bp);
...
8010119a:	e8 8c 2a 00 00       	call   80103c2b <acquire>
...
801011e1:	e8 aa 2a 00 00       	call   80103c90 <release>
      return ip;
...
80101217:	e8 74 2a 00 00       	call   80103c90 <release>
  return ip;
...
80101255:	e8 f8 2a 00 00       	call   80103d52 <memmove>
  brelse(bp);
...
801012fd:	e8 ed 27 00 00       	call   80103aef <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101322:	e8 bd 26 00 00       	call   801039e4 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801013f1:	e8 e1 28 00 00       	call   80103cd7 <memset>
      dip->type = type;
...
80101480:	e8 cd 28 00 00       	call   80103d52 <memmove>
  log_write(bp);
...
80101560:	e8 c6 26 00 00       	call   80103c2b <acquire>
  ip->ref++;
...
80101575:	e8 16 27 00 00       	call   80103c90 <release>
}
...
8010159a:	e8 78 24 00 00       	call   80103a17 <acquiresleep>
  if(ip->valid == 0){
...
80101614:	e8 39 27 00 00       	call   80103d52 <memmove>
    brelse(bp);
...
80101656:	e8 46 24 00 00       	call   80103aa1 <holdingsleep>
...
8010166c:	e8 f5 23 00 00       	call   80103a66 <releasesleep>
}
...
80101698:	e8 7a 23 00 00       	call   80103a17 <acquiresleep>
...
801016b1:	e8 b0 23 00 00       	call   80103a66 <releasesleep>
  acquire(&icache.lock);
801016b6:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016bd:	e8 69 25 00 00       	call   80103c2b <acquire>
  ip->ref--;
...
801016d2:	e8 b9 25 00 00       	call   80103c90 <release>
}
...
801016ea:	e8 3c 25 00 00       	call   80103c2b <acquire>
    int r = ip->ref;
801016ef:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016f2:	c7 04 24 e0 f9 10 80 	movl   $0x8010f9e0,(%esp)
801016f9:	e8 92 25 00 00       	call   80103c90 <release>
    if(r == 1){
...
8010182a:	e8 23 25 00 00       	call   80103d52 <memmove>
    brelse(bp);
...
80101926:	e8 27 24 00 00       	call   80103d52 <memmove>
    log_write(bp);
...
801019a9:	e8 0b 24 00 00       	call   80103db9 <strncmp>
}
801019ae:	c9                   	leave  
801019af:	c3                   	ret    
...
80101ba9:	e8 48 22 00 00       	call   80103df6 <strncpy>
  de.inum = inum;
...
80101bd7:	68 20 6d 10 80       	push   $0x80106d20
...
80101d10:	e8 da 1d 00 00       	call   80103aef <initlock>
...
80101d80:	e8 a6 1e 00 00       	call   80103c2b <acquire>
...
80101dcb:	e8 c0 1e 00 00       	call   80103c90 <release>
...
80101de2:	e8 a9 1e 00 00       	call   80103c90 <release>
    return;
...
80101e1a:	e8 82 1c 00 00       	call   80103aa1 <holdingsleep>
...
80101e47:	e8 df 1d 00 00       	call   80103c2b <acquire>
...
80101ec3:	e8 c8 1d 00 00       	call   80103c90 <release>
}
...
80101fd6:	e8 fc 1c 00 00       	call   80103cd7 <memset>
...
80102017:	e8 0f 1c 00 00       	call   80103c2b <acquire>
8010201c:	83 c4 10             	add    $0x10,%esp
8010201f:	eb c6                	jmp    80101fe7 <kfree+0x43>
    release(&kmem.lock);
80102021:	83 ec 0c             	sub    $0xc,%esp
80102024:	68 40 16 11 80       	push   $0x80111640
80102029:	e8 62 1c 00 00       	call   80103c90 <release>
...
80102079:	e8 71 1a 00 00       	call   80103aef <initlock>
  kmem.use_lock = 0;
...
80102497:	e8 81 18 00 00       	call   80103d1d <memcmp>
...
80102602:	e8 4b 17 00 00       	call   80103d52 <memmove>
...
80102701:	e8 4c 16 00 00       	call   80103d52 <memmove>
...
80102779:	e8 71 13 00 00       	call   80103aef <initlock>
  readsb(dev, &sb);
...
801027b9:	e8 6d 14 00 00       	call   80103c2b <acquire>
...
8010281e:	e8 6d 14 00 00       	call   80103c90 <release>
}
...
80102834:	e8 f2 13 00 00       	call   80103c2b <acquire>
  log.outstanding -= 1;
...
8010286e:	e8 1d 14 00 00       	call   80103c90 <release>
  if(do_commit){
...
801028ab:	e8 7b 13 00 00       	call   80103c2b <acquire>
    log.committing = 0;
...
801028cd:	e8 be 13 00 00       	call   80103c90 <release>
...
80102909:	e8 1d 13 00 00       	call   80103c2b <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102964:	e8 27 13 00 00       	call   80103c90 <release>
}
...
80102992:	e8 bb 13 00 00       	call   80103d52 <memmove>
...
80102a2d:	e8 e6 24 00 00       	call   80104f18 <idtinit>
...
80102a4d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a50:	e8 cc 34 00 00       	call   80105f21 <switchkvm>
  seginit();
80102a55:	e8 7b 33 00 00       	call   80105dd5 <seginit>
  lapicinit();
...
80102aa7:	e8 1a 27 00 00       	call   801051c6 <uartinit>
  pinit();         // process table
80102aac:	e8 b4 06 00 00       	call   80103165 <pinit>
  tvinit();        // trap vectors
80102ab1:	e8 b1 23 00 00       	call   80104e67 <tvinit>
  binit();         // buffer cache
...
80102b2d:	e8 eb 11 00 00       	call   80103d1d <memcmp>
...
80102bf2:	e8 26 11 00 00       	call   80103d1d <memcmp>
...
80102dd7:	e8 13 0d 00 00       	call   80103aef <initlock>
  (*f0)->type = FD_PIPE;
...
80102e2d:	e8 f9 0d 00 00       	call   80103c2b <acquire>
  if(writable){
...
80102e6d:	e8 1e 0e 00 00       	call   80103c90 <release>
...
80102e9c:	e8 ef 0d 00 00       	call   80103c90 <release>
    kfree((char*)p);
...
80102ebd:	e8 69 0d 00 00       	call   80103c2b <acquire>
  for(i = 0; i < n; i++){
...
80102f24:	e8 67 0d 00 00       	call   80103c90 <release>
        return -1;
...
80102f6d:	e8 1e 0d 00 00       	call   80103c90 <release>
  return n;
...
80102f89:	e8 9d 0c 00 00       	call   80103c2b <acquire>
...
80102fcd:	e8 be 0c 00 00       	call   80103c90 <release>
      return -1;
...
80103024:	e8 67 0c 00 00       	call   80103c90 <release>
  return i;
...
8010306d:	e8 b9 0b 00 00       	call   80103c2b <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103095:	e8 f6 0b 00 00       	call   80103c90 <release>
  return 0;
...
801030c4:	e8 c7 0b 00 00       	call   80103c90 <release>
...
801030e1:	c7 80 b0 0f 00 00 5c 	movl   $0x80104e5c,0xfb0(%eax)
801030e8:	4e 10 80 
  sp -= sizeof *p->context;
...
801030fb:	e8 d7 0b 00 00       	call   80103cd7 <memset>
...
8010312d:	e8 5e 0b 00 00       	call   80103c90 <release>
  if (first) {
...
8010316b:	68 f5 6a 10 80       	push   $0x80106af5
80103170:	68 20 1d 11 80       	push   $0x80111d20
80103175:	e8 75 09 00 00       	call   80103aef <initlock>
}
...
801031b7:	68 d8 6b 10 80       	push   $0x80106bd8
801031bc:	e8 87 d1 ff ff       	call   80100348 <panic>
  panic("unknown apicid\n");
801031c1:	83 ec 0c             	sub    $0xc,%esp
801031c4:	68 fc 6a 10 80       	push   $0x80106afc
...
801031fa:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801031fd:	e8 4c 09 00 00       	call   80103b4e <pushcli>
  c = mycpu();
80103202:	e8 78 ff ff ff       	call   8010317f <mycpu>
  p = c->proc;
80103207:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010320d:	e8 79 09 00 00       	call   80103b8b <popcli>
}
...
8010322d:	e8 0e 31 00 00       	call   80106340 <setupkvm>
...
8010324b:	e8 fb 2d 00 00       	call   8010604b <inituvm>
  p->sz = PGSIZE;
...
80103260:	e8 72 0a 00 00       	call   80103cd7 <memset>
...
801032b3:	68 25 6b 10 80       	push   $0x80106b25
801032b8:	50                   	push   %eax
801032b9:	e8 80 0b 00 00       	call   80103e3e <safestrcpy>
  p->cwd = namei("/");
801032be:	c7 04 24 2e 6b 10 80 	movl   $0x80106b2e,(%esp)
...
801032f7:	68 0c 6b 10 80       	push   $0x80106b0c
...
80103324:	e8 2b 2e 00 00       	call   80106154 <deallocuvm>
...
80103341:	e8 a0 2e 00 00       	call   801061e6 <allocuvm>
...
80103353:	e8 db 2b 00 00       	call   80105f33 <switchuvm>
  return 0;
...
80103398:	e8 54 30 00 00       	call   801063f1 <copyuvm>
...
801034a8:	e8 86 2a 00 00       	call   80105f33 <switchuvm>
      p->state = RUNNING;
...
801034be:	e8 ce 09 00 00       	call   80103e91 <swtch>
      switchkvm();
801034c3:	e8 59 2a 00 00       	call   80105f21 <switchkvm>
      c->proc = 0;
...
801034df:	e8 ac 07 00 00       	call   80103c90 <release>
    sti();
...
801034f0:	e8 36 07 00 00       	call   80103c2b <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103513:	e8 d3 06 00 00       	call   80103beb <holding>
...
80103554:	e8 38 09 00 00       	call   80103e91 <swtch>
  mycpu()->intena = intena;
...
801035c0:	68 70 6b 10 80       	push   $0x80106b70
...
80103613:	e8 13 06 00 00       	call   80103c2b <acquire>
...
8010365e:	68 7d 6b 10 80       	push   $0x80106b7d
...
80103673:	e8 b3 05 00 00       	call   80103c2b <acquire>
...
80103690:	e8 fb 05 00 00       	call   80103c90 <release>
}
...
801036c1:	e8 65 05 00 00       	call   80103c2b <acquire>
    release(lk);
801036c6:	89 1c 24             	mov    %ebx,(%esp)
801036c9:	e8 c2 05 00 00       	call   80103c90 <release>
...
801036fa:	e8 91 05 00 00       	call   80103c90 <release>
    acquire(lk);
801036ff:	89 1c 24             	mov    %ebx,(%esp)
80103702:	e8 24 05 00 00       	call   80103c2b <acquire>
...
80103714:	68 89 6b 10 80       	push   $0x80106b89
80103719:	e8 2a cc ff ff       	call   80100348 <panic>
    panic("sleep without lk");
8010371e:	83 ec 0c             	sub    $0xc,%esp
80103721:	68 8f 6b 10 80       	push   $0x80106b8f
...
8010373f:	e8 e7 04 00 00       	call   80103c2b <acquire>
...
8010376e:	e8 5d 2b 00 00       	call   801062d0 <freevm>
        p->pid = 0;
...
8010379a:	e8 f1 04 00 00       	call   80103c90 <release>
        return pid;
...
801037da:	e8 b1 04 00 00       	call   80103c90 <release>
      return -1;
...
80103837:	e8 ef 03 00 00       	call   80103c2b <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010386a:	e8 21 04 00 00       	call   80103c90 <release>
      return 0;
...
8010388d:	e8 fe 03 00 00       	call   80103c90 <release>
  return -1;
...
801038ce:	68 27 6f 10 80       	push   $0x80106f27
...
801038f2:	8b 04 85 00 6c 10 80 	mov    -0x7fef9400(,%eax,4),%eax
801038f9:	85 c0                	test   %eax,%eax
801038fb:	75 b3                	jne    801038b0 <procdump+0x14>
      state = "???";
801038fd:	b8 a0 6b 10 80       	mov    $0x80106ba0,%eax
...
80103915:	e8 f0 01 00 00       	call   80103b0a <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80103928:	68 e1 65 10 80       	push   $0x801065e1
...
80103993:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  struct proc *p;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103996:	b9 54 1d 11 80       	mov    $0x80111d54,%ecx
  int cnt = 0;
8010399b:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039a0:	eb 17                	jmp    801039b9 <getpri+0x2a>
      if(p->pid == PID){
        for(int i =0; i < NOFILE; i++){
801039a2:	83 c2 01             	add    $0x1,%edx
801039a5:	83 fa 0f             	cmp    $0xf,%edx
801039a8:	7f 0c                	jg     801039b6 <getpri+0x27>
          if(p->ofile[i]){
801039aa:	83 7c 91 28 00       	cmpl   $0x0,0x28(%ecx,%edx,4)
801039af:	74 f1                	je     801039a2 <getpri+0x13>
            cnt++;
801039b1:	83 c0 01             	add    $0x1,%eax
801039b4:	eb ec                	jmp    801039a2 <getpri+0x13>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801039b6:	83 c1 7c             	add    $0x7c,%ecx
801039b9:	81 f9 54 3c 11 80    	cmp    $0x80113c54,%ecx
801039bf:	73 0c                	jae    801039cd <getpri+0x3e>
      if(p->pid == PID){
801039c1:	39 59 10             	cmp    %ebx,0x10(%ecx)
801039c4:	75 f0                	jne    801039b6 <getpri+0x27>
        for(int i =0; i < NOFILE; i++){
801039c6:	ba 00 00 00 00       	mov    $0x0,%edx
801039cb:	eb d8                	jmp    801039a5 <getpri+0x16>
          }
        }
      }
    }
...
801039d3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801039d8:	5d                   	pop    %ebp
801039d9:	c3                   	ret    
...
801039eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
801039ee:	68 18 6c 10 80       	push   $0x80106c18
801039f3:	8d 43 04             	lea    0x4(%ebx),%eax
801039f6:	50                   	push   %eax
801039f7:	e8 f3 00 00 00       	call   80103aef <initlock>
  lk->name = name;
801039fc:	8b 45 0c             	mov    0xc(%ebp),%eax
801039ff:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
80103a02:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a08:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
...
80103a1c:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a1f:	8d 73 04             	lea    0x4(%ebx),%esi
80103a22:	83 ec 0c             	sub    $0xc,%esp
80103a25:	56                   	push   %esi
80103a26:	e8 00 02 00 00       	call   80103c2b <acquire>
  while (lk->locked) {
80103a2b:	83 c4 10             	add    $0x10,%esp
80103a2e:	eb 0d                	jmp    80103a3d <acquiresleep+0x26>
    sleep(lk, &lk->lk);
80103a30:	83 ec 08             	sub    $0x8,%esp
80103a33:	56                   	push   %esi
80103a34:	53                   	push   %ebx
80103a35:	e8 60 fc ff ff       	call   8010369a <sleep>
80103a3a:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103a3d:	83 3b 00             	cmpl   $0x0,(%ebx)
80103a40:	75 ee                	jne    80103a30 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103a42:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103a48:	e8 a9 f7 ff ff       	call   801031f6 <myproc>
80103a4d:	8b 40 10             	mov    0x10(%eax),%eax
80103a50:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103a53:	83 ec 0c             	sub    $0xc,%esp
80103a56:	56                   	push   %esi
80103a57:	e8 34 02 00 00       	call   80103c90 <release>
}
...
80103a6b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a6e:	8d 73 04             	lea    0x4(%ebx),%esi
80103a71:	83 ec 0c             	sub    $0xc,%esp
80103a74:	56                   	push   %esi
80103a75:	e8 b1 01 00 00       	call   80103c2b <acquire>
  lk->locked = 0;
80103a7a:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a80:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103a87:	89 1c 24             	mov    %ebx,(%esp)
80103a8a:	e8 70 fd ff ff       	call   801037ff <wakeup>
  release(&lk->lk);
80103a8f:	89 34 24             	mov    %esi,(%esp)
80103a92:	e8 f9 01 00 00       	call   80103c90 <release>
}
...
80103ab0:	e8 76 01 00 00       	call   80103c2b <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103ab5:	83 c4 10             	add    $0x10,%esp
80103ab8:	83 3b 00             	cmpl   $0x0,(%ebx)
80103abb:	75 17                	jne    80103ad4 <holdingsleep+0x33>
80103abd:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103ac2:	83 ec 0c             	sub    $0xc,%esp
80103ac5:	56                   	push   %esi
80103ac6:	e8 c5 01 00 00       	call   80103c90 <release>
  return r;
}
...
80103ad3:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103ad4:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103ad7:	e8 1a f7 ff ff       	call   801031f6 <myproc>
80103adc:	3b 58 10             	cmp    0x10(%eax),%ebx
80103adf:	74 07                	je     80103ae8 <holdingsleep+0x47>
80103ae1:	bb 00 00 00 00       	mov    $0x0,%ebx
80103ae6:	eb da                	jmp    80103ac2 <holdingsleep+0x21>
80103ae8:	bb 01 00 00 00       	mov    $0x1,%ebx
80103aed:	eb d3                	jmp    80103ac2 <holdingsleep+0x21>
...
80103af2:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
80103af5:	8b 55 0c             	mov    0xc(%ebp),%edx
80103af8:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103afb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103b01:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103b08:	5d                   	pop    %ebp
80103b09:	c3                   	ret    

80103b0a <getcallerpcs>:
}
...
80103b0e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103b11:	8b 45 08             	mov    0x8(%ebp),%eax
80103b14:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103b17:	b8 00 00 00 00       	mov    $0x0,%eax
80103b1c:	83 f8 09             	cmp    $0x9,%eax
80103b1f:	7f 25                	jg     80103b46 <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103b21:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103b27:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103b2d:	77 17                	ja     80103b46 <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103b2f:	8b 5a 04             	mov    0x4(%edx),%ebx
80103b32:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103b35:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103b37:	83 c0 01             	add    $0x1,%eax
80103b3a:	eb e0                	jmp    80103b1c <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103b3c:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103b43:	83 c0 01             	add    $0x1,%eax
80103b46:	83 f8 09             	cmp    $0x9,%eax
80103b49:	7e f1                	jle    80103b3c <getcallerpcs+0x32>
}
80103b4b:	5b                   	pop    %ebx
80103b4c:	5d                   	pop    %ebp
80103b4d:	c3                   	ret    
...
80103b57:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103b58:	e8 22 f6 ff ff       	call   8010317f <mycpu>
80103b5d:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103b64:	74 12                	je     80103b78 <pushcli+0x2a>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103b66:	e8 14 f6 ff ff       	call   8010317f <mycpu>
80103b6b:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103b72:	83 c4 04             	add    $0x4,%esp
80103b75:	5b                   	pop    %ebx
80103b76:	5d                   	pop    %ebp
80103b77:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103b78:	e8 02 f6 ff ff       	call   8010317f <mycpu>
80103b7d:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103b83:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103b89:	eb db                	jmp    80103b66 <pushcli+0x18>
...
80103b92:	58                   	pop    %eax
  if(readeflags()&FL_IF)
80103b93:	f6 c4 02             	test   $0x2,%ah
80103b96:	75 28                	jne    80103bc0 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103b98:	e8 e2 f5 ff ff       	call   8010317f <mycpu>
80103b9d:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103ba3:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103ba6:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103bac:	85 d2                	test   %edx,%edx
80103bae:	78 1d                	js     80103bcd <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103bb0:	e8 ca f5 ff ff       	call   8010317f <mycpu>
80103bb5:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103bbc:	74 1c                	je     80103bda <popcli+0x4f>
    sti();
}
80103bbe:	c9                   	leave  
80103bbf:	c3                   	ret    
...
80103bc3:	68 23 6c 10 80       	push   $0x80106c23
80103bc8:	e8 7b c7 ff ff       	call   80100348 <panic>
    panic("popcli");
80103bcd:	83 ec 0c             	sub    $0xc,%esp
80103bd0:	68 3a 6c 10 80       	push   $0x80106c3a
80103bd5:	e8 6e c7 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103bda:	e8 a0 f5 ff ff       	call   8010317f <mycpu>
80103bdf:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103be6:	74 d6                	je     80103bbe <popcli+0x33>
  asm volatile("sti");
80103be8:	fb                   	sti    
}
80103be9:	eb d3                	jmp    80103bbe <popcli+0x33>
...
80103bef:	83 ec 04             	sub    $0x4,%esp
80103bf2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103bf5:	e8 54 ff ff ff       	call   80103b4e <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103bfa:	83 3b 00             	cmpl   $0x0,(%ebx)
80103bfd:	75 12                	jne    80103c11 <holding+0x26>
80103bff:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103c04:	e8 82 ff ff ff       	call   80103b8b <popcli>
}
80103c09:	89 d8                	mov    %ebx,%eax
80103c0b:	83 c4 04             	add    $0x4,%esp
80103c0e:	5b                   	pop    %ebx
80103c0f:	5d                   	pop    %ebp
80103c10:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103c11:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103c14:	e8 66 f5 ff ff       	call   8010317f <mycpu>
80103c19:	39 c3                	cmp    %eax,%ebx
80103c1b:	74 07                	je     80103c24 <holding+0x39>
80103c1d:	bb 00 00 00 00       	mov    $0x0,%ebx
80103c22:	eb e0                	jmp    80103c04 <holding+0x19>
80103c24:	bb 01 00 00 00       	mov    $0x1,%ebx
80103c29:	eb d9                	jmp    80103c04 <holding+0x19>
...
80103c32:	e8 17 ff ff ff       	call   80103b4e <pushcli>
  if(holding(lk))
80103c37:	83 ec 0c             	sub    $0xc,%esp
80103c3a:	ff 75 08             	pushl  0x8(%ebp)
80103c3d:	e8 a9 ff ff ff       	call   80103beb <holding>
80103c42:	83 c4 10             	add    $0x10,%esp
80103c45:	85 c0                	test   %eax,%eax
80103c47:	75 3a                	jne    80103c83 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103c49:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103c4c:	b8 01 00 00 00       	mov    $0x1,%eax
80103c51:	f0 87 02             	lock xchg %eax,(%edx)
80103c54:	85 c0                	test   %eax,%eax
80103c56:	75 f1                	jne    80103c49 <acquire+0x1e>
  __sync_synchronize();
80103c58:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103c5d:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103c60:	e8 1a f5 ff ff       	call   8010317f <mycpu>
80103c65:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103c68:	8b 45 08             	mov    0x8(%ebp),%eax
80103c6b:	83 c0 0c             	add    $0xc,%eax
80103c6e:	83 ec 08             	sub    $0x8,%esp
80103c71:	50                   	push   %eax
80103c72:	8d 45 08             	lea    0x8(%ebp),%eax
80103c75:	50                   	push   %eax
80103c76:	e8 8f fe ff ff       	call   80103b0a <getcallerpcs>
}
...
80103c86:	68 41 6c 10 80       	push   $0x80106c41
80103c8b:	e8 b8 c6 ff ff       	call   80100348 <panic>
...
80103c9b:	e8 4b ff ff ff       	call   80103beb <holding>
80103ca0:	83 c4 10             	add    $0x10,%esp
80103ca3:	85 c0                	test   %eax,%eax
80103ca5:	74 23                	je     80103cca <release+0x3a>
  lk->pcs[0] = 0;
80103ca7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103cae:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103cb5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103cba:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103cc0:	e8 c6 fe ff ff       	call   80103b8b <popcli>
}
...
80103ccd:	68 49 6c 10 80       	push   $0x80106c49
...
80103cdf:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103ce2:	f6 c2 03             	test   $0x3,%dl
80103ce5:	75 05                	jne    80103cec <memset+0x15>
80103ce7:	f6 c1 03             	test   $0x3,%cl
80103cea:	74 0e                	je     80103cfa <memset+0x23>
  asm volatile("cld; rep stosb" :
80103cec:	89 d7                	mov    %edx,%edi
80103cee:	8b 45 0c             	mov    0xc(%ebp),%eax
80103cf1:	fc                   	cld    
80103cf2:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80103cf4:	89 d0                	mov    %edx,%eax
80103cf6:	5b                   	pop    %ebx
80103cf7:	5f                   	pop    %edi
80103cf8:	5d                   	pop    %ebp
80103cf9:	c3                   	ret    
    c &= 0xFF;
80103cfa:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103cfe:	c1 e9 02             	shr    $0x2,%ecx
80103d01:	89 f8                	mov    %edi,%eax
80103d03:	c1 e0 18             	shl    $0x18,%eax
80103d06:	89 fb                	mov    %edi,%ebx
80103d08:	c1 e3 10             	shl    $0x10,%ebx
80103d0b:	09 d8                	or     %ebx,%eax
80103d0d:	89 fb                	mov    %edi,%ebx
80103d0f:	c1 e3 08             	shl    $0x8,%ebx
80103d12:	09 d8                	or     %ebx,%eax
80103d14:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103d16:	89 d7                	mov    %edx,%edi
80103d18:	fc                   	cld    
80103d19:	f3 ab                	rep stos %eax,%es:(%edi)
80103d1b:	eb d7                	jmp    80103cf4 <memset+0x1d>
...
80103d22:	8b 4d 08             	mov    0x8(%ebp),%ecx
80103d25:	8b 55 0c             	mov    0xc(%ebp),%edx
80103d28:	8b 45 10             	mov    0x10(%ebp),%eax
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
80103d2b:	8d 70 ff             	lea    -0x1(%eax),%esi
80103d2e:	85 c0                	test   %eax,%eax
80103d30:	74 1c                	je     80103d4e <memcmp+0x31>
    if(*s1 != *s2)
80103d32:	0f b6 01             	movzbl (%ecx),%eax
80103d35:	0f b6 1a             	movzbl (%edx),%ebx
80103d38:	38 d8                	cmp    %bl,%al
80103d3a:	75 0a                	jne    80103d46 <memcmp+0x29>
      return *s1 - *s2;
    s1++, s2++;
80103d3c:	83 c1 01             	add    $0x1,%ecx
80103d3f:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103d42:	89 f0                	mov    %esi,%eax
80103d44:	eb e5                	jmp    80103d2b <memcmp+0xe>
      return *s1 - *s2;
80103d46:	0f b6 c0             	movzbl %al,%eax
80103d49:	0f b6 db             	movzbl %bl,%ebx
80103d4c:	29 d8                	sub    %ebx,%eax
  }
...
80103d5a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103d5d:	8b 55 10             	mov    0x10(%ebp),%edx
  ...
  d = dst;
  if(s < d && s + n > d){
80103d60:	39 c1                	cmp    %eax,%ecx
80103d62:	73 3a                	jae    80103d9e <memmove+0x4c>
80103d64:	8d 1c 11             	lea    (%ecx,%edx,1),%ebx
80103d67:	39 c3                	cmp    %eax,%ebx
80103d69:	76 37                	jbe    80103da2 <memmove+0x50>
    s += n;
    d += n;
80103d6b:	8d 0c 10             	lea    (%eax,%edx,1),%ecx
    while(n-- > 0)
80103d6e:	eb 0d                	jmp    80103d7d <memmove+0x2b>
      *--d = *--s;
80103d70:	83 eb 01             	sub    $0x1,%ebx
80103d73:	83 e9 01             	sub    $0x1,%ecx
80103d76:	0f b6 13             	movzbl (%ebx),%edx
80103d79:	88 11                	mov    %dl,(%ecx)
    while(n-- > 0)
80103d7b:	89 f2                	mov    %esi,%edx
80103d7d:	8d 72 ff             	lea    -0x1(%edx),%esi
80103d80:	85 d2                	test   %edx,%edx
80103d82:	75 ec                	jne    80103d70 <memmove+0x1e>
80103d84:	eb 14                	jmp    80103d9a <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103d86:	0f b6 11             	movzbl (%ecx),%edx
80103d89:	88 13                	mov    %dl,(%ebx)
80103d8b:	8d 5b 01             	lea    0x1(%ebx),%ebx
80103d8e:	8d 49 01             	lea    0x1(%ecx),%ecx
    while(n-- > 0)
80103d91:	89 f2                	mov    %esi,%edx
80103d93:	8d 72 ff             	lea    -0x1(%edx),%esi
80103d96:	85 d2                	test   %edx,%edx
80103d98:	75 ec                	jne    80103d86 <memmove+0x34>
...
80103da0:	eb f1                	jmp    80103d93 <memmove+0x41>
80103da2:	89 c3                	mov    %eax,%ebx
80103da4:	eb ed                	jmp    80103d93 <memmove+0x41>
...
80103da9:	ff 75 10             	pushl  0x10(%ebp)
80103dac:	ff 75 0c             	pushl  0xc(%ebp)
80103daf:	ff 75 08             	pushl  0x8(%ebp)
80103db2:	e8 9b ff ff ff       	call   80103d52 <memmove>
}
80103db7:	c9                   	leave  
80103db8:	c3                   	ret    
...
80103dc3:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103dc6:	eb 09                	jmp    80103dd1 <strncmp+0x18>
    n--, p++, q++;
80103dc8:	83 e8 01             	sub    $0x1,%eax
80103dcb:	83 c2 01             	add    $0x1,%edx
80103dce:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103dd1:	85 c0                	test   %eax,%eax
80103dd3:	74 0b                	je     80103de0 <strncmp+0x27>
80103dd5:	0f b6 1a             	movzbl (%edx),%ebx
80103dd8:	84 db                	test   %bl,%bl
80103dda:	74 04                	je     80103de0 <strncmp+0x27>
80103ddc:	3a 19                	cmp    (%ecx),%bl
80103dde:	74 e8                	je     80103dc8 <strncmp+0xf>
  if(n == 0)
80103de0:	85 c0                	test   %eax,%eax
80103de2:	74 0b                	je     80103def <strncmp+0x36>
    return 0;
  return (uchar)*p - (uchar)*q;
80103de4:	0f b6 02             	movzbl (%edx),%eax
80103de7:	0f b6 11             	movzbl (%ecx),%edx
80103dea:	29 d0                	sub    %edx,%eax
}
80103dec:	5b                   	pop    %ebx
80103ded:	5d                   	pop    %ebp
80103dee:	c3                   	ret    
...
80103df4:	eb f6                	jmp    80103dec <strncmp+0x33>
...
80103dfc:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80103dff:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103e02:	8b 45 08             	mov    0x8(%ebp),%eax
80103e05:	eb 04                	jmp    80103e0b <strncpy+0x15>
80103e07:	89 fb                	mov    %edi,%ebx
80103e09:	89 f0                	mov    %esi,%eax
80103e0b:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103e0e:	85 c9                	test   %ecx,%ecx
80103e10:	7e 1d                	jle    80103e2f <strncpy+0x39>
80103e12:	8d 7b 01             	lea    0x1(%ebx),%edi
80103e15:	8d 70 01             	lea    0x1(%eax),%esi
80103e18:	0f b6 1b             	movzbl (%ebx),%ebx
80103e1b:	88 18                	mov    %bl,(%eax)
80103e1d:	89 d1                	mov    %edx,%ecx
80103e1f:	84 db                	test   %bl,%bl
80103e21:	75 e4                	jne    80103e07 <strncpy+0x11>
80103e23:	89 f0                	mov    %esi,%eax
80103e25:	eb 08                	jmp    80103e2f <strncpy+0x39>
    ;
  while(n-- > 0)
    *s++ = 0;
80103e27:	c6 00 00             	movb   $0x0,(%eax)
  while(n-- > 0)
80103e2a:	89 ca                	mov    %ecx,%edx
    *s++ = 0;
80103e2c:	8d 40 01             	lea    0x1(%eax),%eax
  while(n-- > 0)
80103e2f:	8d 4a ff             	lea    -0x1(%edx),%ecx
80103e32:	85 d2                	test   %edx,%edx
80103e34:	7f f1                	jg     80103e27 <strncpy+0x31>
  return os;
}
...
80103e41:	57                   	push   %edi
80103e42:	56                   	push   %esi
80103e43:	53                   	push   %ebx
80103e44:	8b 45 08             	mov    0x8(%ebp),%eax
80103e47:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80103e4a:	8b 55 10             	mov    0x10(%ebp),%edx
  char *os;

  os = s;
  if(n <= 0)
80103e4d:	85 d2                	test   %edx,%edx
80103e4f:	7e 23                	jle    80103e74 <safestrcpy+0x36>
80103e51:	89 c1                	mov    %eax,%ecx
80103e53:	eb 04                	jmp    80103e59 <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103e55:	89 fb                	mov    %edi,%ebx
80103e57:	89 f1                	mov    %esi,%ecx
80103e59:	83 ea 01             	sub    $0x1,%edx
80103e5c:	85 d2                	test   %edx,%edx
80103e5e:	7e 11                	jle    80103e71 <safestrcpy+0x33>
80103e60:	8d 7b 01             	lea    0x1(%ebx),%edi
80103e63:	8d 71 01             	lea    0x1(%ecx),%esi
80103e66:	0f b6 1b             	movzbl (%ebx),%ebx
80103e69:	88 19                	mov    %bl,(%ecx)
80103e6b:	84 db                	test   %bl,%bl
80103e6d:	75 e6                	jne    80103e55 <safestrcpy+0x17>
80103e6f:	89 f1                	mov    %esi,%ecx
    ;
  *s = 0;
80103e71:	c6 01 00             	movb   $0x0,(%ecx)
  return os;
}
80103e74:	5b                   	pop    %ebx
80103e75:	5e                   	pop    %esi
...
80103e84:	eb 03                	jmp    80103e89 <strlen+0x10>
80103e86:	83 c0 01             	add    $0x1,%eax
80103e89:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103e8d:	75 f7                	jne    80103e86 <strlen+0xd>
    ;
  return n;
}
80103e8f:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103e91:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103e95:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103e9c:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103e9d:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103e9f:	89 d4                	mov    %edx,%esp
...
80103ead:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103eb0:	e8 41 f3 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103eb5:	8b 00                	mov    (%eax),%eax
80103eb7:	39 d8                	cmp    %ebx,%eax
80103eb9:	76 19                	jbe    80103ed4 <fetchint+0x2e>
80103ebb:	8d 53 04             	lea    0x4(%ebx),%edx
80103ebe:	39 d0                	cmp    %edx,%eax
80103ec0:	72 19                	jb     80103edb <fetchint+0x35>
    return -1;
  *ip = *(int*)(addr);
80103ec2:	8b 13                	mov    (%ebx),%edx
80103ec4:	8b 45 0c             	mov    0xc(%ebp),%eax
80103ec7:	89 10                	mov    %edx,(%eax)
  return 0;
80103ec9:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103ece:	83 c4 04             	add    $0x4,%esp
80103ed1:	5b                   	pop    %ebx
80103ed2:	5d                   	pop    %ebp
80103ed3:	c3                   	ret    
    return -1;
80103ed4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ed9:	eb f3                	jmp    80103ece <fetchint+0x28>
80103edb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ee0:	eb ec                	jmp    80103ece <fetchint+0x28>
...
80103ee9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103eec:	e8 05 f3 ff ff       	call   801031f6 <myproc>

  if(addr >= curproc->sz)
80103ef1:	39 18                	cmp    %ebx,(%eax)
80103ef3:	76 26                	jbe    80103f1b <fetchstr+0x39>
    return -1;
  *pp = (char*)addr;
80103ef5:	8b 55 0c             	mov    0xc(%ebp),%edx
80103ef8:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80103efa:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103efc:	89 d8                	mov    %ebx,%eax
80103efe:	39 d0                	cmp    %edx,%eax
80103f00:	73 0e                	jae    80103f10 <fetchstr+0x2e>
    if(*s == 0)
80103f02:	80 38 00             	cmpb   $0x0,(%eax)
80103f05:	74 05                	je     80103f0c <fetchstr+0x2a>
  for(s = *pp; s < ep; s++){
80103f07:	83 c0 01             	add    $0x1,%eax
80103f0a:	eb f2                	jmp    80103efe <fetchstr+0x1c>
      return s - *pp;
80103f0c:	29 d8                	sub    %ebx,%eax
80103f0e:	eb 05                	jmp    80103f15 <fetchstr+0x33>
  }
  return -1;
...
80103f20:	eb f3                	jmp    80103f15 <fetchstr+0x33>
...
80103f28:	e8 c9 f2 ff ff       	call   801031f6 <myproc>
80103f2d:	8b 50 18             	mov    0x18(%eax),%edx
80103f30:	8b 45 08             	mov    0x8(%ebp),%eax
80103f33:	c1 e0 02             	shl    $0x2,%eax
80103f36:	03 42 44             	add    0x44(%edx),%eax
80103f39:	83 ec 08             	sub    $0x8,%esp
80103f3c:	ff 75 0c             	pushl  0xc(%ebp)
80103f3f:	83 c0 04             	add    $0x4,%eax
80103f42:	50                   	push   %eax
80103f43:	e8 5e ff ff ff       	call   80103ea6 <fetchint>
}
80103f48:	c9                   	leave  
80103f49:	c3                   	ret    
...
80103f4f:	83 ec 10             	sub    $0x10,%esp
80103f52:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80103f55:	e8 9c f2 ff ff       	call   801031f6 <myproc>
80103f5a:	89 c6                	mov    %eax,%esi

  if(argint(n, &i) < 0)
80103f5c:	83 ec 08             	sub    $0x8,%esp
80103f5f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103f62:	50                   	push   %eax
80103f63:	ff 75 08             	pushl  0x8(%ebp)
80103f66:	e8 b7 ff ff ff       	call   80103f22 <argint>
80103f6b:	83 c4 10             	add    $0x10,%esp
80103f6e:	85 c0                	test   %eax,%eax
80103f70:	78 24                	js     80103f96 <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80103f72:	85 db                	test   %ebx,%ebx
80103f74:	78 27                	js     80103f9d <argptr+0x53>
80103f76:	8b 16                	mov    (%esi),%edx
80103f78:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103f7b:	39 c2                	cmp    %eax,%edx
80103f7d:	76 25                	jbe    80103fa4 <argptr+0x5a>
80103f7f:	01 c3                	add    %eax,%ebx
80103f81:	39 da                	cmp    %ebx,%edx
80103f83:	72 26                	jb     80103fab <argptr+0x61>
    return -1;
  *pp = (char*)i;
...
80103f8f:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103f92:	5b                   	pop    %ebx
80103f93:	5e                   	pop    %esi
80103f94:	5d                   	pop    %ebp
80103f95:	c3                   	ret    
...
80103f9b:	eb f2                	jmp    80103f8f <argptr+0x45>
    return -1;
80103f9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fa2:	eb eb                	jmp    80103f8f <argptr+0x45>
80103fa4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fa9:	eb e4                	jmp    80103f8f <argptr+0x45>
80103fab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103fb0:	eb dd                	jmp    80103f8f <argptr+0x45>
...
80103fbf:	e8 5e ff ff ff       	call   80103f22 <argint>
80103fc4:	83 c4 10             	add    $0x10,%esp
80103fc7:	85 c0                	test   %eax,%eax
80103fc9:	78 13                	js     80103fde <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80103fcb:	83 ec 08             	sub    $0x8,%esp
80103fce:	ff 75 0c             	pushl  0xc(%ebp)
80103fd1:	ff 75 f4             	pushl  -0xc(%ebp)
80103fd4:	e8 09 ff ff ff       	call   80103ee2 <fetchstr>
...
80103fe3:	eb f7                	jmp    80103fdc <argstr+0x2a>
...
80103fe9:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80103fec:	e8 05 f2 ff ff       	call   801031f6 <myproc>
80103ff1:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80103ff3:	8b 40 18             	mov    0x18(%eax),%eax
80103ff6:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80103ff9:	8d 50 ff             	lea    -0x1(%eax),%edx
80103ffc:	83 fa 18             	cmp    $0x18,%edx
80103fff:	77 18                	ja     80104019 <syscall+0x34>
80104001:	8b 14 85 80 6c 10 80 	mov    -0x7fef9380(,%eax,4),%edx
80104008:	85 d2                	test   %edx,%edx
8010400a:	74 0d                	je     80104019 <syscall+0x34>
    curproc->tf->eax = syscalls[num]();
8010400c:	ff d2                	call   *%edx
8010400e:	8b 53 18             	mov    0x18(%ebx),%edx
80104011:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104018:	c3                   	ret    
            curproc->pid, curproc->name, num);
80104019:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
8010401c:	50                   	push   %eax
8010401d:	52                   	push   %edx
8010401e:	ff 73 10             	pushl  0x10(%ebx)
80104021:	68 51 6c 10 80       	push   $0x80106c51
80104026:	e8 e0 c5 ff ff       	call   8010060b <cprintf>
    curproc->tf->eax = -1;
8010402b:	8b 43 18             	mov    0x18(%ebx),%eax
8010402e:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
80104035:	83 c4 10             	add    $0x10,%esp
}
80104038:	eb da                	jmp    80104014 <syscall+0x2f>
...
80104042:	89 d6                	mov    %edx,%esi
80104044:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
80104046:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104049:	52                   	push   %edx
8010404a:	50                   	push   %eax
8010404b:	e8 d2 fe ff ff       	call   80103f22 <argint>
80104050:	83 c4 10             	add    $0x10,%esp
80104053:	85 c0                	test   %eax,%eax
80104055:	78 2e                	js     80104085 <argfd+0x4b>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104057:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
8010405b:	77 2f                	ja     8010408c <argfd+0x52>
8010405d:	e8 94 f1 ff ff       	call   801031f6 <myproc>
80104062:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104065:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104069:	85 c0                	test   %eax,%eax
8010406b:	74 26                	je     80104093 <argfd+0x59>
    return -1;
  if(pfd)
8010406d:	85 f6                	test   %esi,%esi
8010406f:	74 02                	je     80104073 <argfd+0x39>
    *pfd = fd;
80104071:	89 16                	mov    %edx,(%esi)
  if(pf)
80104073:	85 db                	test   %ebx,%ebx
80104075:	74 23                	je     8010409a <argfd+0x60>
    *pf = f;
80104077:	89 03                	mov    %eax,(%ebx)
  return 0;
...
8010408a:	eb f2                	jmp    8010407e <argfd+0x44>
    return -1;
8010408c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104091:	eb eb                	jmp    8010407e <argfd+0x44>
80104093:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104098:	eb e4                	jmp    8010407e <argfd+0x44>
  return 0;
8010409a:	b8 00 00 00 00       	mov    $0x0,%eax
8010409f:	eb dd                	jmp    8010407e <argfd+0x44>
...
801040a8:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
801040aa:	e8 47 f1 ff ff       	call   801031f6 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
801040af:	ba 00 00 00 00       	mov    $0x0,%edx
801040b4:	83 fa 0f             	cmp    $0xf,%edx
801040b7:	7f 18                	jg     801040d1 <fdalloc+0x30>
    if(curproc->ofile[fd] == 0){
801040b9:	83 7c 90 28 00       	cmpl   $0x0,0x28(%eax,%edx,4)
801040be:	74 05                	je     801040c5 <fdalloc+0x24>
  for(fd = 0; fd < NOFILE; fd++){
801040c0:	83 c2 01             	add    $0x1,%edx
801040c3:	eb ef                	jmp    801040b4 <fdalloc+0x13>
      curproc->ofile[fd] = f;
801040c5:	89 5c 90 28          	mov    %ebx,0x28(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
}
801040c9:	89 d0                	mov    %edx,%eax
801040cb:	83 c4 04             	add    $0x4,%esp
801040ce:	5b                   	pop    %ebx
801040cf:	5d                   	pop    %ebp
801040d0:	c3                   	ret    
  return -1;
801040d1:	ba ff ff ff ff       	mov    $0xffffffff,%edx
801040d6:	eb f1                	jmp    801040c9 <fdalloc+0x28>
...
801040dd:	83 ec 10             	sub    $0x10,%esp
801040e0:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801040e2:	b8 20 00 00 00       	mov    $0x20,%eax
801040e7:	89 c6                	mov    %eax,%esi
801040e9:	39 43 58             	cmp    %eax,0x58(%ebx)
801040ec:	76 2e                	jbe    8010411c <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801040ee:	6a 10                	push   $0x10
801040f0:	50                   	push   %eax
801040f1:	8d 45 e8             	lea    -0x18(%ebp),%eax
801040f4:	50                   	push   %eax
801040f5:	53                   	push   %ebx
801040f6:	e8 78 d6 ff ff       	call   80101773 <readi>
801040fb:	83 c4 10             	add    $0x10,%esp
801040fe:	83 f8 10             	cmp    $0x10,%eax
80104101:	75 0c                	jne    8010410f <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
80104103:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
80104108:	75 1e                	jne    80104128 <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
8010410a:	8d 46 10             	lea    0x10(%esi),%eax
8010410d:	eb d8                	jmp    801040e7 <isdirempty+0xf>
      panic("isdirempty: readi");
8010410f:	83 ec 0c             	sub    $0xc,%esp
80104112:	68 e8 6c 10 80       	push   $0x80106ce8
80104117:	e8 2c c2 ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
8010411c:	b8 01 00 00 00       	mov    $0x1,%eax
}
...
80104127:	c3                   	ret    
      return 0;
80104128:	b8 00 00 00 00       	mov    $0x0,%eax
8010412d:	eb f2                	jmp    80104121 <isdirempty+0x49>
...
80104132:	57                   	push   %edi
80104133:	56                   	push   %esi
80104134:	53                   	push   %ebx
80104135:	83 ec 44             	sub    $0x44,%esp
80104138:	89 55 c4             	mov    %edx,-0x3c(%ebp)
8010413b:	89 4d c0             	mov    %ecx,-0x40(%ebp)
...
80104141:	8d 55 d6             	lea    -0x2a(%ebp),%edx
80104144:	52                   	push   %edx
80104145:	50                   	push   %eax
80104146:	e8 ae da ff ff       	call   80101bf9 <nameiparent>
8010414b:	89 c6                	mov    %eax,%esi
8010414d:	83 c4 10             	add    $0x10,%esp
80104150:	85 c0                	test   %eax,%eax
80104152:	0f 84 3a 01 00 00    	je     80104292 <create+0x163>
    return 0;
  ilock(dp);
80104158:	83 ec 0c             	sub    $0xc,%esp
8010415b:	50                   	push   %eax
8010415c:	e8 20 d4 ff ff       	call   80101581 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104161:	83 c4 0c             	add    $0xc,%esp
80104164:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104167:	50                   	push   %eax
80104168:	8d 45 d6             	lea    -0x2a(%ebp),%eax
8010416b:	50                   	push   %eax
8010416c:	56                   	push   %esi
8010416d:	e8 3e d8 ff ff       	call   801019b0 <dirlookup>
80104172:	89 c3                	mov    %eax,%ebx
80104174:	83 c4 10             	add    $0x10,%esp
80104177:	85 c0                	test   %eax,%eax
80104179:	74 3f                	je     801041ba <create+0x8b>
    iunlockput(dp);
8010417b:	83 ec 0c             	sub    $0xc,%esp
8010417e:	56                   	push   %esi
8010417f:	e8 a4 d5 ff ff       	call   80101728 <iunlockput>
    ilock(ip);
80104184:	89 1c 24             	mov    %ebx,(%esp)
80104187:	e8 f5 d3 ff ff       	call   80101581 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010418c:	83 c4 10             	add    $0x10,%esp
8010418f:	66 83 7d c4 02       	cmpw   $0x2,-0x3c(%ebp)
80104194:	75 11                	jne    801041a7 <create+0x78>
80104196:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010419b:	75 0a                	jne    801041a7 <create+0x78>
...
8010419f:	8d 65 f4             	lea    -0xc(%ebp),%esp
801041a2:	5b                   	pop    %ebx
801041a3:	5e                   	pop    %esi
801041a4:	5f                   	pop    %edi
801041a5:	5d                   	pop    %ebp
...
801041ab:	e8 78 d5 ff ff       	call   80101728 <iunlockput>
    return 0;
801041b0:	83 c4 10             	add    $0x10,%esp
801041b3:	bb 00 00 00 00       	mov    $0x0,%ebx
801041b8:	eb e3                	jmp    8010419d <create+0x6e>
  if((ip = ialloc(dp->dev, type)) == 0)
801041ba:	0f bf 45 c4          	movswl -0x3c(%ebp),%eax
801041be:	83 ec 08             	sub    $0x8,%esp
801041c1:	50                   	push   %eax
801041c2:	ff 36                	pushl  (%esi)
801041c4:	e8 b5 d1 ff ff       	call   8010137e <ialloc>
801041c9:	89 c3                	mov    %eax,%ebx
801041cb:	83 c4 10             	add    $0x10,%esp
801041ce:	85 c0                	test   %eax,%eax
801041d0:	74 55                	je     80104227 <create+0xf8>
  ilock(ip);
801041d2:	83 ec 0c             	sub    $0xc,%esp
801041d5:	50                   	push   %eax
801041d6:	e8 a6 d3 ff ff       	call   80101581 <ilock>
  ip->major = major;
801041db:	0f b7 45 c0          	movzwl -0x40(%ebp),%eax
801041df:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801041e3:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801041e7:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801041ed:	89 1c 24             	mov    %ebx,(%esp)
801041f0:	e8 2b d2 ff ff       	call   80101420 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801041f5:	83 c4 10             	add    $0x10,%esp
801041f8:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
801041fd:	74 35                	je     80104234 <create+0x105>
  if(dirlink(dp, name, ip->inum) < 0)
801041ff:	83 ec 04             	sub    $0x4,%esp
80104202:	ff 73 04             	pushl  0x4(%ebx)
80104205:	8d 45 d6             	lea    -0x2a(%ebp),%eax
80104208:	50                   	push   %eax
80104209:	56                   	push   %esi
8010420a:	e8 21 d9 ff ff       	call   80101b30 <dirlink>
8010420f:	83 c4 10             	add    $0x10,%esp
80104212:	85 c0                	test   %eax,%eax
80104214:	78 6f                	js     80104285 <create+0x156>
  iunlockput(dp);
80104216:	83 ec 0c             	sub    $0xc,%esp
80104219:	56                   	push   %esi
8010421a:	e8 09 d5 ff ff       	call   80101728 <iunlockput>
  return ip;
8010421f:	83 c4 10             	add    $0x10,%esp
80104222:	e9 76 ff ff ff       	jmp    8010419d <create+0x6e>
    panic("create: ialloc");
80104227:	83 ec 0c             	sub    $0xc,%esp
8010422a:	68 fa 6c 10 80       	push   $0x80106cfa
8010422f:	e8 14 c1 ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
80104234:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104238:	83 c0 01             	add    $0x1,%eax
8010423b:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
...
8010424b:	ff 73 04             	pushl  0x4(%ebx)
8010424e:	68 0a 6d 10 80       	push   $0x80106d0a
80104253:	53                   	push   %ebx
80104254:	e8 d7 d8 ff ff       	call   80101b30 <dirlink>
80104259:	83 c4 10             	add    $0x10,%esp
8010425c:	85 c0                	test   %eax,%eax
8010425e:	78 18                	js     80104278 <create+0x149>
80104260:	83 ec 04             	sub    $0x4,%esp
80104263:	ff 76 04             	pushl  0x4(%esi)
80104266:	68 09 6d 10 80       	push   $0x80106d09
8010426b:	53                   	push   %ebx
8010426c:	e8 bf d8 ff ff       	call   80101b30 <dirlink>
80104271:	83 c4 10             	add    $0x10,%esp
80104274:	85 c0                	test   %eax,%eax
80104276:	79 87                	jns    801041ff <create+0xd0>
      panic("create dots");
80104278:	83 ec 0c             	sub    $0xc,%esp
8010427b:	68 0c 6d 10 80       	push   $0x80106d0c
80104280:	e8 c3 c0 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
80104285:	83 ec 0c             	sub    $0xc,%esp
80104288:	68 18 6d 10 80       	push   $0x80106d18
8010428d:	e8 b6 c0 ff ff       	call   80100348 <panic>
    return 0;
80104292:	89 c3                	mov    %eax,%ebx
80104294:	e9 04 ff ff ff       	jmp    8010419d <create+0x6e>
...
8010429d:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
801042a0:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801042a3:	ba 00 00 00 00       	mov    $0x0,%edx
801042a8:	b8 00 00 00 00       	mov    $0x0,%eax
801042ad:	e8 88 fd ff ff       	call   8010403a <argfd>
801042b2:	85 c0                	test   %eax,%eax
801042b4:	78 23                	js     801042d9 <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
801042b6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801042b9:	e8 e3 fd ff ff       	call   801040a1 <fdalloc>
801042be:	89 c3                	mov    %eax,%ebx
801042c0:	85 c0                	test   %eax,%eax
801042c2:	78 1c                	js     801042e0 <sys_dup+0x47>
  filedup(f);
801042c4:	83 ec 0c             	sub    $0xc,%esp
801042c7:	ff 75 f4             	pushl  -0xc(%ebp)
801042ca:	e8 bf c9 ff ff       	call   80100c8e <filedup>
  return fd;
...
801042d8:	c3                   	ret    
    return -1;
801042d9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042de:	eb f2                	jmp    801042d2 <sys_dup+0x39>
    return -1;
801042e0:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042e5:	eb eb                	jmp    801042d2 <sys_dup+0x39>
...
801042ed:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801042f0:	ba 00 00 00 00       	mov    $0x0,%edx
801042f5:	b8 00 00 00 00       	mov    $0x0,%eax
801042fa:	e8 3b fd ff ff       	call   8010403a <argfd>
801042ff:	85 c0                	test   %eax,%eax
80104301:	78 43                	js     80104346 <sys_read+0x5f>
80104303:	83 ec 08             	sub    $0x8,%esp
80104306:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104309:	50                   	push   %eax
8010430a:	6a 02                	push   $0x2
8010430c:	e8 11 fc ff ff       	call   80103f22 <argint>
80104311:	83 c4 10             	add    $0x10,%esp
80104314:	85 c0                	test   %eax,%eax
80104316:	78 35                	js     8010434d <sys_read+0x66>
80104318:	83 ec 04             	sub    $0x4,%esp
8010431b:	ff 75 f0             	pushl  -0x10(%ebp)
8010431e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104321:	50                   	push   %eax
80104322:	6a 01                	push   $0x1
80104324:	e8 21 fc ff ff       	call   80103f4a <argptr>
80104329:	83 c4 10             	add    $0x10,%esp
8010432c:	85 c0                	test   %eax,%eax
8010432e:	78 24                	js     80104354 <sys_read+0x6d>
  return fileread(f, p, n);
80104330:	83 ec 04             	sub    $0x4,%esp
80104333:	ff 75 f0             	pushl  -0x10(%ebp)
80104336:	ff 75 ec             	pushl  -0x14(%ebp)
80104339:	ff 75 f4             	pushl  -0xc(%ebp)
8010433c:	e8 96 ca ff ff       	call   80100dd7 <fileread>
...
8010434b:	eb f7                	jmp    80104344 <sys_read+0x5d>
8010434d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104352:	eb f0                	jmp    80104344 <sys_read+0x5d>
80104354:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104359:	eb e9                	jmp    80104344 <sys_read+0x5d>
...
8010436e:	e8 c7 fc ff ff       	call   8010403a <argfd>
80104373:	85 c0                	test   %eax,%eax
80104375:	78 43                	js     801043ba <sys_write+0x5f>
80104377:	83 ec 08             	sub    $0x8,%esp
8010437a:	8d 45 f0             	lea    -0x10(%ebp),%eax
8010437d:	50                   	push   %eax
8010437e:	6a 02                	push   $0x2
80104380:	e8 9d fb ff ff       	call   80103f22 <argint>
80104385:	83 c4 10             	add    $0x10,%esp
80104388:	85 c0                	test   %eax,%eax
8010438a:	78 35                	js     801043c1 <sys_write+0x66>
8010438c:	83 ec 04             	sub    $0x4,%esp
8010438f:	ff 75 f0             	pushl  -0x10(%ebp)
80104392:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104395:	50                   	push   %eax
80104396:	6a 01                	push   $0x1
80104398:	e8 ad fb ff ff       	call   80103f4a <argptr>
8010439d:	83 c4 10             	add    $0x10,%esp
801043a0:	85 c0                	test   %eax,%eax
801043a2:	78 24                	js     801043c8 <sys_write+0x6d>
  return filewrite(f, p, n);
801043a4:	83 ec 04             	sub    $0x4,%esp
801043a7:	ff 75 f0             	pushl  -0x10(%ebp)
801043aa:	ff 75 ec             	pushl  -0x14(%ebp)
801043ad:	ff 75 f4             	pushl  -0xc(%ebp)
801043b0:	e8 a7 ca ff ff       	call   80100e5c <filewrite>
...
801043bf:	eb f7                	jmp    801043b8 <sys_write+0x5d>
801043c1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043c6:	eb f0                	jmp    801043b8 <sys_write+0x5d>
801043c8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043cd:	eb e9                	jmp    801043b8 <sys_write+0x5d>
...
801043d2:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
801043d5:	8d 4d f0             	lea    -0x10(%ebp),%ecx
801043d8:	8d 55 f4             	lea    -0xc(%ebp),%edx
801043db:	b8 00 00 00 00       	mov    $0x0,%eax
801043e0:	e8 55 fc ff ff       	call   8010403a <argfd>
801043e5:	85 c0                	test   %eax,%eax
801043e7:	78 25                	js     8010440e <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
801043e9:	e8 08 ee ff ff       	call   801031f6 <myproc>
801043ee:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043f1:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801043f8:	00 
  fileclose(f);
801043f9:	83 ec 0c             	sub    $0xc,%esp
801043fc:	ff 75 f0             	pushl  -0x10(%ebp)
801043ff:	e8 cf c8 ff ff       	call   80100cd3 <fileclose>
  return 0;
...
80104413:	eb f7                	jmp    8010440c <sys_close+0x3d>
...
8010441b:	8d 4d f4             	lea    -0xc(%ebp),%ecx
8010441e:	ba 00 00 00 00       	mov    $0x0,%edx
80104423:	b8 00 00 00 00       	mov    $0x0,%eax
80104428:	e8 0d fc ff ff       	call   8010403a <argfd>
8010442d:	85 c0                	test   %eax,%eax
8010442f:	78 2a                	js     8010445b <sys_fstat+0x46>
80104431:	83 ec 04             	sub    $0x4,%esp
80104434:	6a 14                	push   $0x14
80104436:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104439:	50                   	push   %eax
8010443a:	6a 01                	push   $0x1
8010443c:	e8 09 fb ff ff       	call   80103f4a <argptr>
80104441:	83 c4 10             	add    $0x10,%esp
80104444:	85 c0                	test   %eax,%eax
80104446:	78 1a                	js     80104462 <sys_fstat+0x4d>
  return filestat(f, st);
80104448:	83 ec 08             	sub    $0x8,%esp
8010444b:	ff 75 f0             	pushl  -0x10(%ebp)
8010444e:	ff 75 f4             	pushl  -0xc(%ebp)
80104451:	e8 3a c9 ff ff       	call   80100d90 <filestat>
...
80104460:	eb f7                	jmp    80104459 <sys_fstat+0x44>
80104462:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104467:	eb f0                	jmp    80104459 <sys_fstat+0x44>
...
8010446e:	83 ec 28             	sub    $0x28,%esp
  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
80104471:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104474:	50                   	push   %eax
80104475:	6a 00                	push   $0x0
80104477:	e8 36 fb ff ff       	call   80103fb2 <argstr>
8010447c:	83 c4 10             	add    $0x10,%esp
8010447f:	85 c0                	test   %eax,%eax
80104481:	0f 88 32 01 00 00    	js     801045b9 <sys_link+0x150>
80104487:	83 ec 08             	sub    $0x8,%esp
8010448a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010448d:	50                   	push   %eax
8010448e:	6a 01                	push   $0x1
80104490:	e8 1d fb ff ff       	call   80103fb2 <argstr>
80104495:	83 c4 10             	add    $0x10,%esp
80104498:	85 c0                	test   %eax,%eax
8010449a:	0f 88 20 01 00 00    	js     801045c0 <sys_link+0x157>
  begin_op();
801044a0:	e8 09 e3 ff ff       	call   801027ae <begin_op>
  if((ip = namei(old)) == 0){
801044a5:	83 ec 0c             	sub    $0xc,%esp
801044a8:	ff 75 e0             	pushl  -0x20(%ebp)
801044ab:	e8 31 d7 ff ff       	call   80101be1 <namei>
801044b0:	89 c3                	mov    %eax,%ebx
801044b2:	83 c4 10             	add    $0x10,%esp
801044b5:	85 c0                	test   %eax,%eax
801044b7:	0f 84 99 00 00 00    	je     80104556 <sys_link+0xed>
  ilock(ip);
801044bd:	83 ec 0c             	sub    $0xc,%esp
801044c0:	50                   	push   %eax
801044c1:	e8 bb d0 ff ff       	call   80101581 <ilock>
  if(ip->type == T_DIR){
801044c6:	83 c4 10             	add    $0x10,%esp
801044c9:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801044ce:	0f 84 8e 00 00 00    	je     80104562 <sys_link+0xf9>
  ip->nlink++;
801044d4:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
801044d8:	83 c0 01             	add    $0x1,%eax
801044db:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
801044df:	83 ec 0c             	sub    $0xc,%esp
801044e2:	53                   	push   %ebx
801044e3:	e8 38 cf ff ff       	call   80101420 <iupdate>
  iunlock(ip);
801044e8:	89 1c 24             	mov    %ebx,(%esp)
801044eb:	e8 53 d1 ff ff       	call   80101643 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801044f0:	83 c4 08             	add    $0x8,%esp
801044f3:	8d 45 ea             	lea    -0x16(%ebp),%eax
801044f6:	50                   	push   %eax
801044f7:	ff 75 e4             	pushl  -0x1c(%ebp)
801044fa:	e8 fa d6 ff ff       	call   80101bf9 <nameiparent>
801044ff:	89 c6                	mov    %eax,%esi
80104501:	83 c4 10             	add    $0x10,%esp
80104504:	85 c0                	test   %eax,%eax
80104506:	74 7e                	je     80104586 <sys_link+0x11d>
  ilock(dp);
80104508:	83 ec 0c             	sub    $0xc,%esp
8010450b:	50                   	push   %eax
8010450c:	e8 70 d0 ff ff       	call   80101581 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80104511:	83 c4 10             	add    $0x10,%esp
80104514:	8b 03                	mov    (%ebx),%eax
80104516:	39 06                	cmp    %eax,(%esi)
80104518:	75 60                	jne    8010457a <sys_link+0x111>
...
80104525:	e8 06 d6 ff ff       	call   80101b30 <dirlink>
8010452a:	83 c4 10             	add    $0x10,%esp
8010452d:	85 c0                	test   %eax,%eax
8010452f:	78 49                	js     8010457a <sys_link+0x111>
  iunlockput(dp);
80104531:	83 ec 0c             	sub    $0xc,%esp
80104534:	56                   	push   %esi
80104535:	e8 ee d1 ff ff       	call   80101728 <iunlockput>
  iput(ip);
8010453a:	89 1c 24             	mov    %ebx,(%esp)
8010453d:	e8 46 d1 ff ff       	call   80101688 <iput>
  end_op();
80104542:	e8 e1 e2 ff ff       	call   80102828 <end_op>
  return 0;
...
80104555:	c3                   	ret    
    end_op();
80104556:	e8 cd e2 ff ff       	call   80102828 <end_op>
    return -1;
8010455b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104560:	eb ed                	jmp    8010454f <sys_link+0xe6>
    iunlockput(ip);
...
80104578:	eb d5                	jmp    8010454f <sys_link+0xe6>
    iunlockput(dp);
8010457a:	83 ec 0c             	sub    $0xc,%esp
8010457d:	56                   	push   %esi
8010457e:	e8 a5 d1 ff ff       	call   80101728 <iunlockput>
    goto bad;
80104583:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104586:	83 ec 0c             	sub    $0xc,%esp
80104589:	53                   	push   %ebx
8010458a:	e8 f2 cf ff ff       	call   80101581 <ilock>
  ip->nlink--;
8010458f:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104593:	83 e8 01             	sub    $0x1,%eax
80104596:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010459a:	89 1c 24             	mov    %ebx,(%esp)
8010459d:	e8 7e ce ff ff       	call   80101420 <iupdate>
  iunlockput(ip);
801045a2:	89 1c 24             	mov    %ebx,(%esp)
801045a5:	e8 7e d1 ff ff       	call   80101728 <iunlockput>
  end_op();
801045aa:	e8 79 e2 ff ff       	call   80102828 <end_op>
  return -1;
801045af:	83 c4 10             	add    $0x10,%esp
801045b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045b7:	eb 96                	jmp    8010454f <sys_link+0xe6>
    return -1;
801045b9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045be:	eb 8f                	jmp    8010454f <sys_link+0xe6>
801045c0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801045c5:	eb 88                	jmp    8010454f <sys_link+0xe6>
...
801045cd:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
801045d0:	8d 45 c4             	lea    -0x3c(%ebp),%eax
801045d3:	50                   	push   %eax
801045d4:	6a 00                	push   $0x0
801045d6:	e8 d7 f9 ff ff       	call   80103fb2 <argstr>
801045db:	83 c4 10             	add    $0x10,%esp
801045de:	85 c0                	test   %eax,%eax
801045e0:	0f 88 83 01 00 00    	js     80104769 <sys_unlink+0x1a2>
  begin_op();
801045e6:	e8 c3 e1 ff ff       	call   801027ae <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801045eb:	83 ec 08             	sub    $0x8,%esp
801045ee:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045f1:	50                   	push   %eax
801045f2:	ff 75 c4             	pushl  -0x3c(%ebp)
801045f5:	e8 ff d5 ff ff       	call   80101bf9 <nameiparent>
801045fa:	89 c6                	mov    %eax,%esi
801045fc:	83 c4 10             	add    $0x10,%esp
801045ff:	85 c0                	test   %eax,%eax
80104601:	0f 84 ed 00 00 00    	je     801046f4 <sys_unlink+0x12d>
  ilock(dp);
80104607:	83 ec 0c             	sub    $0xc,%esp
8010460a:	50                   	push   %eax
8010460b:	e8 71 cf ff ff       	call   80101581 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104610:	83 c4 08             	add    $0x8,%esp
80104613:	68 0a 6d 10 80       	push   $0x80106d0a
80104618:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010461b:	50                   	push   %eax
8010461c:	e8 7a d3 ff ff       	call   8010199b <namecmp>
80104621:	83 c4 10             	add    $0x10,%esp
80104624:	85 c0                	test   %eax,%eax
80104626:	0f 84 fc 00 00 00    	je     80104728 <sys_unlink+0x161>
8010462c:	83 ec 08             	sub    $0x8,%esp
8010462f:	68 09 6d 10 80       	push   $0x80106d09
80104634:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104637:	50                   	push   %eax
80104638:	e8 5e d3 ff ff       	call   8010199b <namecmp>
8010463d:	83 c4 10             	add    $0x10,%esp
80104640:	85 c0                	test   %eax,%eax
80104642:	0f 84 e0 00 00 00    	je     80104728 <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104648:	83 ec 04             	sub    $0x4,%esp
8010464b:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010464e:	50                   	push   %eax
8010464f:	8d 45 ca             	lea    -0x36(%ebp),%eax
80104652:	50                   	push   %eax
80104653:	56                   	push   %esi
80104654:	e8 57 d3 ff ff       	call   801019b0 <dirlookup>
80104659:	89 c3                	mov    %eax,%ebx
8010465b:	83 c4 10             	add    $0x10,%esp
8010465e:	85 c0                	test   %eax,%eax
80104660:	0f 84 c2 00 00 00    	je     80104728 <sys_unlink+0x161>
  ilock(ip);
...
80104672:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104677:	0f 8e 83 00 00 00    	jle    80104700 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010467d:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104682:	0f 84 85 00 00 00    	je     8010470d <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
80104688:	83 ec 04             	sub    $0x4,%esp
8010468b:	6a 10                	push   $0x10
8010468d:	6a 00                	push   $0x0
8010468f:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104692:	57                   	push   %edi
80104693:	e8 3f f6 ff ff       	call   80103cd7 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104698:	6a 10                	push   $0x10
8010469a:	ff 75 c0             	pushl  -0x40(%ebp)
8010469d:	57                   	push   %edi
8010469e:	56                   	push   %esi
8010469f:	e8 cc d1 ff ff       	call   80101870 <writei>
801046a4:	83 c4 20             	add    $0x20,%esp
801046a7:	83 f8 10             	cmp    $0x10,%eax
801046aa:	0f 85 90 00 00 00    	jne    80104740 <sys_unlink+0x179>
  if(ip->type == T_DIR){
801046b0:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
801046b5:	0f 84 92 00 00 00    	je     8010474d <sys_unlink+0x186>
  iunlockput(dp);
...
801046da:	e8 49 d0 ff ff       	call   80101728 <iunlockput>
  end_op();
801046df:	e8 44 e1 ff ff       	call   80102828 <end_op>
  return 0;
801046e4:	83 c4 10             	add    $0x10,%esp
801046e7:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
801046f3:	c3                   	ret    
    end_op();
801046f4:	e8 2f e1 ff ff       	call   80102828 <end_op>
    return -1;
801046f9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046fe:	eb ec                	jmp    801046ec <sys_unlink+0x125>
    panic("unlink: nlink < 1");
80104700:	83 ec 0c             	sub    $0xc,%esp
80104703:	68 28 6d 10 80       	push   $0x80106d28
80104708:	e8 3b bc ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
8010470d:	89 d8                	mov    %ebx,%eax
8010470f:	e8 c4 f9 ff ff       	call   801040d8 <isdirempty>
80104714:	85 c0                	test   %eax,%eax
80104716:	0f 85 6c ff ff ff    	jne    80104688 <sys_unlink+0xc1>
    iunlockput(ip);
...
8010472c:	e8 f7 cf ff ff       	call   80101728 <iunlockput>
  end_op();
80104731:	e8 f2 e0 ff ff       	call   80102828 <end_op>
  return -1;
80104736:	83 c4 10             	add    $0x10,%esp
80104739:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010473e:	eb ac                	jmp    801046ec <sys_unlink+0x125>
    panic("unlink: writei");
80104740:	83 ec 0c             	sub    $0xc,%esp
80104743:	68 3a 6d 10 80       	push   $0x80106d3a
80104748:	e8 fb bb ff ff       	call   80100348 <panic>
    dp->nlink--;
8010474d:	0f b7 46 56          	movzwl 0x56(%esi),%eax
80104751:	83 e8 01             	sub    $0x1,%eax
80104754:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104758:	83 ec 0c             	sub    $0xc,%esp
8010475b:	56                   	push   %esi
8010475c:	e8 bf cc ff ff       	call   80101420 <iupdate>
80104761:	83 c4 10             	add    $0x10,%esp
80104764:	e9 52 ff ff ff       	jmp    801046bb <sys_unlink+0xf4>
    return -1;
80104769:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010476e:	e9 79 ff ff ff       	jmp    801046ec <sys_unlink+0x125>
...
80104779:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
8010477c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010477f:	50                   	push   %eax
80104780:	6a 00                	push   $0x0
80104782:	e8 2b f8 ff ff       	call   80103fb2 <argstr>
80104787:	83 c4 10             	add    $0x10,%esp
8010478a:	85 c0                	test   %eax,%eax
8010478c:	0f 88 30 01 00 00    	js     801048c2 <sys_open+0x14f>
80104792:	83 ec 08             	sub    $0x8,%esp
80104795:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104798:	50                   	push   %eax
80104799:	6a 01                	push   $0x1
8010479b:	e8 82 f7 ff ff       	call   80103f22 <argint>
801047a0:	83 c4 10             	add    $0x10,%esp
801047a3:	85 c0                	test   %eax,%eax
801047a5:	0f 88 21 01 00 00    	js     801048cc <sys_open+0x159>
    return -1;

  begin_op();
801047ab:	e8 fe df ff ff       	call   801027ae <begin_op>

  if(omode & O_CREATE){
801047b0:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
801047b4:	0f 84 84 00 00 00    	je     8010483e <sys_open+0xcb>
    ip = create(path, T_FILE, 0, 0);
801047ba:	83 ec 0c             	sub    $0xc,%esp
801047bd:	6a 00                	push   $0x0
801047bf:	b9 00 00 00 00       	mov    $0x0,%ecx
801047c4:	ba 02 00 00 00       	mov    $0x2,%edx
801047c9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801047cc:	e8 5e f9 ff ff       	call   8010412f <create>
801047d1:	89 c6                	mov    %eax,%esi
    if(ip == 0){
801047d3:	83 c4 10             	add    $0x10,%esp
801047d6:	85 c0                	test   %eax,%eax
801047d8:	74 58                	je     80104832 <sys_open+0xbf>
      end_op();
      return -1;
    }
  }
...
801047da:	e8 4e c4 ff ff       	call   80100c2d <filealloc>
801047df:	89 c3                	mov    %eax,%ebx
801047e1:	85 c0                	test   %eax,%eax
801047e3:	0f 84 ae 00 00 00    	je     80104897 <sys_open+0x124>
801047e9:	e8 b3 f8 ff ff       	call   801040a1 <fdalloc>
801047ee:	89 c7                	mov    %eax,%edi
801047f0:	85 c0                	test   %eax,%eax
801047f2:	0f 88 9f 00 00 00    	js     80104897 <sys_open+0x124>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801047fc:	e8 42 ce ff ff       	call   80101643 <iunlock>
  end_op();
80104801:	e8 22 e0 ff ff       	call   80102828 <end_op>

  f->type = FD_INODE;
80104806:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
8010480c:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
8010480f:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
80104816:	8b 45 e0             	mov    -0x20(%ebp),%eax
80104819:	83 c4 10             	add    $0x10,%esp
8010481c:	a8 01                	test   $0x1,%al
8010481e:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80104822:	a8 03                	test   $0x3,%al
80104824:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
80104828:	89 f8                	mov    %edi,%eax
8010482a:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010482d:	5b                   	pop    %ebx
8010482e:	5e                   	pop    %esi
8010482f:	5f                   	pop    %edi
80104830:	5d                   	pop    %ebp
...
80104832:	e8 f1 df ff ff       	call   80102828 <end_op>
      return -1;
80104837:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010483c:	eb ea                	jmp    80104828 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
8010483e:	83 ec 0c             	sub    $0xc,%esp
80104841:	ff 75 e4             	pushl  -0x1c(%ebp)
80104844:	e8 98 d3 ff ff       	call   80101be1 <namei>
80104849:	89 c6                	mov    %eax,%esi
8010484b:	83 c4 10             	add    $0x10,%esp
8010484e:	85 c0                	test   %eax,%eax
80104850:	74 39                	je     8010488b <sys_open+0x118>
    ilock(ip);
80104852:	83 ec 0c             	sub    $0xc,%esp
80104855:	50                   	push   %eax
80104856:	e8 26 cd ff ff       	call   80101581 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010485b:	83 c4 10             	add    $0x10,%esp
8010485e:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104863:	0f 85 71 ff ff ff    	jne    801047da <sys_open+0x67>
80104869:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010486d:	0f 84 67 ff ff ff    	je     801047da <sys_open+0x67>
      iunlockput(ip);
...
80104889:	eb 9d                	jmp    80104828 <sys_open+0xb5>
      end_op();
8010488b:	e8 98 df ff ff       	call   80102828 <end_op>
      return -1;
80104890:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104895:	eb 91                	jmp    80104828 <sys_open+0xb5>
    if(f)
80104897:	85 db                	test   %ebx,%ebx
80104899:	74 0c                	je     801048a7 <sys_open+0x134>
      fileclose(f);
8010489b:	83 ec 0c             	sub    $0xc,%esp
8010489e:	53                   	push   %ebx
8010489f:	e8 2f c4 ff ff       	call   80100cd3 <fileclose>
801048a4:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801048a7:	83 ec 0c             	sub    $0xc,%esp
801048aa:	56                   	push   %esi
801048ab:	e8 78 ce ff ff       	call   80101728 <iunlockput>
    end_op();
801048b0:	e8 73 df ff ff       	call   80102828 <end_op>
    return -1;
801048b5:	83 c4 10             	add    $0x10,%esp
801048b8:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048bd:	e9 66 ff ff ff       	jmp    80104828 <sys_open+0xb5>
    return -1;
801048c2:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048c7:	e9 5c ff ff ff       	jmp    80104828 <sys_open+0xb5>
801048cc:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801048d1:	e9 52 ff ff ff       	jmp    80104828 <sys_open+0xb5>
...
801048d9:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801048dc:	e8 cd de ff ff       	call   801027ae <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
801048e1:	83 ec 08             	sub    $0x8,%esp
801048e4:	8d 45 f4             	lea    -0xc(%ebp),%eax
801048e7:	50                   	push   %eax
801048e8:	6a 00                	push   $0x0
801048ea:	e8 c3 f6 ff ff       	call   80103fb2 <argstr>
801048ef:	83 c4 10             	add    $0x10,%esp
801048f2:	85 c0                	test   %eax,%eax
801048f4:	78 36                	js     8010492c <sys_mkdir+0x56>
801048f6:	83 ec 0c             	sub    $0xc,%esp
801048f9:	6a 00                	push   $0x0
801048fb:	b9 00 00 00 00       	mov    $0x0,%ecx
80104900:	ba 01 00 00 00       	mov    $0x1,%edx
80104905:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104908:	e8 22 f8 ff ff       	call   8010412f <create>
8010490d:	83 c4 10             	add    $0x10,%esp
80104910:	85 c0                	test   %eax,%eax
80104912:	74 18                	je     8010492c <sys_mkdir+0x56>
    end_op();
    return -1;
  }
  iunlockput(ip);
...
80104918:	e8 0b ce ff ff       	call   80101728 <iunlockput>
  end_op();
8010491d:	e8 06 df ff ff       	call   80102828 <end_op>
  return 0;
80104922:	83 c4 10             	add    $0x10,%esp
80104925:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010492a:	c9                   	leave  
8010492b:	c3                   	ret    
    end_op();
8010492c:	e8 f7 de ff ff       	call   80102828 <end_op>
    return -1;
80104931:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104936:	eb f2                	jmp    8010492a <sys_mkdir+0x54>
...
801049b3:	b8 00 00 00 00       	mov    $0x0,%eax
}
801049b8:	c9                   	leave  
801049b9:	c3                   	ret    
    end_op();
801049ba:	e8 69 de ff ff       	call   80102828 <end_op>
    return -1;
801049bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801049c4:	eb f2                	jmp    801049b8 <sys_mknod+0x80>
...
80104a07:	e8 75 cb ff ff       	call   80101581 <ilock>
  if(ip->type != T_DIR){
80104a0c:	83 c4 10             	add    $0x10,%esp
80104a0f:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104a14:	75 37                	jne    80104a4d <sys_chdir+0x87>
    iunlockput(ip);
    end_op();
    return -1;
  }
...
80104a1a:	e8 24 cc ff ff       	call   80101643 <iunlock>
  iput(curproc->cwd);
80104a1f:	83 c4 04             	add    $0x4,%esp
80104a22:	ff 76 68             	pushl  0x68(%esi)
80104a25:	e8 5e cc ff ff       	call   80101688 <iput>
  end_op();
80104a2a:	e8 f9 dd ff ff       	call   80102828 <end_op>
  curproc->cwd = ip;
80104a2f:	89 5e 68             	mov    %ebx,0x68(%esi)
  return 0;
...
80104a69:	81 ec 9c 00 00 00    	sub    $0x9c,%esp
...
80104a75:	e8 38 f5 ff ff       	call   80103fb2 <argstr>
80104a7a:	83 c4 10             	add    $0x10,%esp
80104a7d:	85 c0                	test   %eax,%eax
80104a7f:	0f 88 a8 00 00 00    	js     80104b2d <sys_exec+0xc8>
80104a85:	83 ec 08             	sub    $0x8,%esp
80104a88:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104a8e:	50                   	push   %eax
80104a8f:	6a 01                	push   $0x1
80104a91:	e8 8c f4 ff ff       	call   80103f22 <argint>
80104a96:	83 c4 10             	add    $0x10,%esp
80104a99:	85 c0                	test   %eax,%eax
80104a9b:	0f 88 93 00 00 00    	js     80104b34 <sys_exec+0xcf>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104aa1:	83 ec 04             	sub    $0x4,%esp
80104aa4:	68 80 00 00 00       	push   $0x80
80104aa9:	6a 00                	push   $0x0
80104aab:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104ab1:	50                   	push   %eax
80104ab2:	e8 20 f2 ff ff       	call   80103cd7 <memset>
80104ab7:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104aba:	bb 00 00 00 00       	mov    $0x0,%ebx
    if(i >= NELEM(argv))
80104abf:	83 fb 1f             	cmp    $0x1f,%ebx
80104ac2:	77 77                	ja     80104b3b <sys_exec+0xd6>
      return -1;
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104ac4:	83 ec 08             	sub    $0x8,%esp
80104ac7:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104acd:	50                   	push   %eax
80104ace:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104ad4:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104ad7:	50                   	push   %eax
80104ad8:	e8 c9 f3 ff ff       	call   80103ea6 <fetchint>
80104add:	83 c4 10             	add    $0x10,%esp
80104ae0:	85 c0                	test   %eax,%eax
80104ae2:	78 5e                	js     80104b42 <sys_exec+0xdd>
      return -1;
    if(uarg == 0){
80104ae4:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104aea:	85 c0                	test   %eax,%eax
80104aec:	74 1d                	je     80104b0b <sys_exec+0xa6>
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
80104aee:	83 ec 08             	sub    $0x8,%esp
80104af1:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104af8:	52                   	push   %edx
80104af9:	50                   	push   %eax
80104afa:	e8 e3 f3 ff ff       	call   80103ee2 <fetchstr>
80104aff:	83 c4 10             	add    $0x10,%esp
80104b02:	85 c0                	test   %eax,%eax
80104b04:	78 46                	js     80104b4c <sys_exec+0xe7>
  for(i=0;; i++){
80104b06:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104b09:	eb b4                	jmp    80104abf <sys_exec+0x5a>
      argv[i] = 0;
80104b0b:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104b12:	00 00 00 00 
      return -1;
  }
  return exec(path, argv);
80104b16:	83 ec 08             	sub    $0x8,%esp
80104b19:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104b1f:	50                   	push   %eax
80104b20:	ff 75 f4             	pushl  -0xc(%ebp)
80104b23:	e8 aa bd ff ff       	call   801008d2 <exec>
80104b28:	83 c4 10             	add    $0x10,%esp
80104b2b:	eb 1a                	jmp    80104b47 <sys_exec+0xe2>
    return -1;
80104b2d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b32:	eb 13                	jmp    80104b47 <sys_exec+0xe2>
80104b34:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b39:	eb 0c                	jmp    80104b47 <sys_exec+0xe2>
      return -1;
80104b3b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b40:	eb 05                	jmp    80104b47 <sys_exec+0xe2>
      return -1;
...
80104b51:	eb f4                	jmp    80104b47 <sys_exec+0xe2>
...
80104b5a:	6a 08                	push   $0x8
80104b5c:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104b5f:	50                   	push   %eax
80104b60:	6a 00                	push   $0x0
80104b62:	e8 e3 f3 ff ff       	call   80103f4a <argptr>
80104b67:	83 c4 10             	add    $0x10,%esp
80104b6a:	85 c0                	test   %eax,%eax
80104b6c:	78 77                	js     80104be5 <sys_pipe+0x92>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104b6e:	83 ec 08             	sub    $0x8,%esp
80104b71:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104b74:	50                   	push   %eax
80104b75:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b78:	50                   	push   %eax
80104b79:	e8 b7 e1 ff ff       	call   80102d35 <pipealloc>
80104b7e:	83 c4 10             	add    $0x10,%esp
80104b81:	85 c0                	test   %eax,%eax
80104b83:	78 67                	js     80104bec <sys_pipe+0x99>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104b85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b88:	e8 14 f5 ff ff       	call   801040a1 <fdalloc>
80104b8d:	89 c3                	mov    %eax,%ebx
80104b8f:	85 c0                	test   %eax,%eax
80104b91:	78 21                	js     80104bb4 <sys_pipe+0x61>
80104b93:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b96:	e8 06 f5 ff ff       	call   801040a1 <fdalloc>
80104b9b:	85 c0                	test   %eax,%eax
80104b9d:	78 15                	js     80104bb4 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
...
80104ba2:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104ba4:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104ba7:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
...
80104bb6:	78 0d                	js     80104bc5 <sys_pipe+0x72>
      myproc()->ofile[fd0] = 0;
80104bb8:	e8 39 e6 ff ff       	call   801031f6 <myproc>
80104bbd:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104bc4:	00 
    fileclose(rf);
80104bc5:	83 ec 0c             	sub    $0xc,%esp
80104bc8:	ff 75 f0             	pushl  -0x10(%ebp)
80104bcb:	e8 03 c1 ff ff       	call   80100cd3 <fileclose>
    fileclose(wf);
80104bd0:	83 c4 04             	add    $0x4,%esp
80104bd3:	ff 75 ec             	pushl  -0x14(%ebp)
80104bd6:	e8 f8 c0 ff ff       	call   80100cd3 <fileclose>
    return -1;
80104bdb:	83 c4 10             	add    $0x10,%esp
80104bde:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104be3:	eb ca                	jmp    80104baf <sys_pipe+0x5c>
    return -1;
80104be5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bea:	eb c3                	jmp    80104baf <sys_pipe+0x5c>
    return -1;
80104bec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bf1:	eb bc                	jmp    80104baf <sys_pipe+0x5c>
...
80104bf6:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104bf9:	e8 70 e7 ff ff       	call   8010336e <fork>
}
80104bfe:	c9                   	leave  
80104bff:	c3                   	ret    
...
80104c03:	83 ec 08             	sub    $0x8,%esp
  exit();
80104c06:	e8 97 e9 ff ff       	call   801035a2 <exit>
...
80104c15:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104c18:	e8 0e eb ff ff       	call   8010372b <wait>
}
80104c1d:	c9                   	leave  
80104c1e:	c3                   	ret    
...
80104c22:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
80104c2b:	e8 f2 f2 ff ff       	call   80103f22 <argint>
80104c30:	83 c4 10             	add    $0x10,%esp
80104c33:	85 c0                	test   %eax,%eax
80104c35:	78 10                	js     80104c47 <sys_kill+0x28>
    return -1;
  return kill(pid);
80104c37:	83 ec 0c             	sub    $0xc,%esp
80104c3a:	ff 75 f4             	pushl  -0xc(%ebp)
80104c3d:	e8 e6 eb ff ff       	call   80103828 <kill>
...
80104c4c:	eb f7                	jmp    80104c45 <sys_kill+0x26>
...
80104c51:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104c54:	e8 9d e5 ff ff       	call   801031f6 <myproc>
80104c59:	8b 40 10             	mov    0x10(%eax),%eax
}
80104c5c:	c9                   	leave  
80104c5d:	c3                   	ret    
...
80104c6b:	e8 b2 f2 ff ff       	call   80103f22 <argint>
80104c70:	83 c4 10             	add    $0x10,%esp
80104c73:	85 c0                	test   %eax,%eax
80104c75:	78 27                	js     80104c9e <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80104c77:	e8 7a e5 ff ff       	call   801031f6 <myproc>
80104c7c:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104c7e:	83 ec 0c             	sub    $0xc,%esp
80104c81:	ff 75 f4             	pushl  -0xc(%ebp)
80104c84:	e8 78 e6 ff ff       	call   80103301 <growproc>
80104c89:	83 c4 10             	add    $0x10,%esp
80104c8c:	85 c0                	test   %eax,%eax
80104c8e:	78 07                	js     80104c97 <sys_sbrk+0x39>
    return -1;
  return addr;
}
...
80104c96:	c3                   	ret    
    return -1;
80104c97:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104c9c:	eb f2                	jmp    80104c90 <sys_sbrk+0x32>
    return -1;
80104c9e:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104ca3:	eb eb                	jmp    80104c90 <sys_sbrk+0x32>
...
80104cb2:	e8 6b f2 ff ff       	call   80103f22 <argint>
80104cb7:	83 c4 10             	add    $0x10,%esp
80104cba:	85 c0                	test   %eax,%eax
80104cbc:	78 75                	js     80104d33 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104cbe:	83 ec 0c             	sub    $0xc,%esp
80104cc1:	68 60 3c 11 80       	push   $0x80113c60
80104cc6:	e8 60 ef ff ff       	call   80103c2b <acquire>
  ticks0 = ticks;
80104ccb:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  while(ticks - ticks0 < n){
80104cd1:	83 c4 10             	add    $0x10,%esp
80104cd4:	a1 a0 44 11 80       	mov    0x801144a0,%eax
80104cd9:	29 d8                	sub    %ebx,%eax
80104cdb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104cde:	73 39                	jae    80104d19 <sys_sleep+0x74>
    if(myproc()->killed){
80104ce0:	e8 11 e5 ff ff       	call   801031f6 <myproc>
80104ce5:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ce9:	75 17                	jne    80104d02 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104ceb:	83 ec 08             	sub    $0x8,%esp
80104cee:	68 60 3c 11 80       	push   $0x80113c60
80104cf3:	68 a0 44 11 80       	push   $0x801144a0
80104cf8:	e8 9d e9 ff ff       	call   8010369a <sleep>
80104cfd:	83 c4 10             	add    $0x10,%esp
80104d00:	eb d2                	jmp    80104cd4 <sys_sleep+0x2f>
      release(&tickslock);
80104d02:	83 ec 0c             	sub    $0xc,%esp
80104d05:	68 60 3c 11 80       	push   $0x80113c60
80104d0a:	e8 81 ef ff ff       	call   80103c90 <release>
      return -1;
80104d0f:	83 c4 10             	add    $0x10,%esp
80104d12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d17:	eb 15                	jmp    80104d2e <sys_sleep+0x89>
  }
  release(&tickslock);
80104d19:	83 ec 0c             	sub    $0xc,%esp
80104d1c:	68 60 3c 11 80       	push   $0x80113c60
80104d21:	e8 6a ef ff ff       	call   80103c90 <release>
  return 0;
...
80104d38:	eb f4                	jmp    80104d2e <sys_sleep+0x89>
...
80104d3e:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80104d41:	68 60 3c 11 80       	push   $0x80113c60
80104d46:	e8 e0 ee ff ff       	call   80103c2b <acquire>
  xticks = ticks;
80104d4b:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  release(&tickslock);
80104d51:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d58:	e8 33 ef ff ff       	call   80103c90 <release>
  return xticks;
}
...
80104d70:	e8 ad f1 ff ff       	call   80103f22 <argint>
80104d75:	83 c4 10             	add    $0x10,%esp
80104d78:	85 c0                	test   %eax,%eax
80104d7a:	78 28                	js     80104da4 <sys_setpri+0x40>
    return -1;
  }
  if(argint(1, &pri) < 0){
80104d7c:	83 ec 08             	sub    $0x8,%esp
80104d7f:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d82:	50                   	push   %eax
80104d83:	6a 01                	push   $0x1
80104d85:	e8 98 f1 ff ff       	call   80103f22 <argint>
80104d8a:	83 c4 10             	add    $0x10,%esp
80104d8d:	85 c0                	test   %eax,%eax
80104d8f:	78 1a                	js     80104dab <sys_setpri+0x47>
    return -1;
  }
...
80104d9a:	e8 af eb ff ff       	call   8010394e <setpri>
...
80104da9:	eb f7                	jmp    80104da2 <sys_setpri+0x3e>
    return -1;
80104dab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104db0:	eb f0                	jmp    80104da2 <sys_setpri+0x3e>
...
80104dbe:	e8 5f f1 ff ff       	call   80103f22 <argint>
80104dc3:	83 c4 10             	add    $0x10,%esp
80104dc6:	85 c0                	test   %eax,%eax
80104dc8:	78 10                	js     80104dda <sys_getpri+0x28>
    return -1;
  }
  return getpri(PID);
80104dca:	83 ec 0c             	sub    $0xc,%esp
80104dcd:	ff 75 f4             	pushl  -0xc(%ebp)
80104dd0:	e8 ba eb ff ff       	call   8010398f <getpri>
...
80104ddf:	eb f7                	jmp    80104dd8 <sys_getpri+0x26>
...
80104de4:	83 ec 20             	sub    $0x20,%esp
  int pri;
   if(argint(1, &pri) < 0){
80104de7:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104dea:	50                   	push   %eax
80104deb:	6a 01                	push   $0x1
80104ded:	e8 30 f1 ff ff       	call   80103f22 <argint>
80104df2:	83 c4 10             	add    $0x10,%esp
80104df5:	85 c0                	test   %eax,%eax
80104df7:	78 10                	js     80104e09 <sys_fork2+0x28>
    return -1;
  }
  return fork2(pri);
80104df9:	83 ec 0c             	sub    $0xc,%esp
80104dfc:	ff 75 f4             	pushl  -0xc(%ebp)
80104dff:	e8 cc eb ff ff       	call   801039d0 <fork2>
...
80104e0e:	eb f7                	jmp    80104e07 <sys_fork2+0x26>

80104e10 <sys_getpinfo>:
...
80104e42:	eb f7                	jmp    80104e3b <sys_getpinfo+0x2b>
...
80104e53:	54                   	push   %esp
  call trap
80104e54:	e8 e3 00 00 00       	call   80104f3c <trap>
  addl $4, %esp
...
80104e72:	eb 4a                	jmp    80104ebe <tvinit+0x57>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104e74:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104e7b:	66 89 0c c5 a0 3c 11 	mov    %cx,-0x7feec360(,%eax,8)
80104e82:	80 
80104e83:	66 c7 04 c5 a2 3c 11 	movw   $0x8,-0x7feec35e(,%eax,8)
80104e8a:	80 08 00 
80104e8d:	c6 04 c5 a4 3c 11 80 	movb   $0x0,-0x7feec35c(,%eax,8)
80104e94:	00 
80104e95:	0f b6 14 c5 a5 3c 11 	movzbl -0x7feec35b(,%eax,8),%edx
80104e9c:	80 
80104e9d:	83 e2 f0             	and    $0xfffffff0,%edx
80104ea0:	83 ca 0e             	or     $0xe,%edx
80104ea3:	83 e2 8f             	and    $0xffffff8f,%edx
80104ea6:	83 ca 80             	or     $0xffffff80,%edx
80104ea9:	88 14 c5 a5 3c 11 80 	mov    %dl,-0x7feec35b(,%eax,8)
80104eb0:	c1 e9 10             	shr    $0x10,%ecx
80104eb3:	66 89 0c c5 a6 3c 11 	mov    %cx,-0x7feec35a(,%eax,8)
80104eba:	80 
  for(i = 0; i < 256; i++)
80104ebb:	83 c0 01             	add    $0x1,%eax
80104ebe:	3d ff 00 00 00       	cmp    $0xff,%eax
80104ec3:	7e af                	jle    80104e74 <tvinit+0xd>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104ec5:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104ecb:	66 89 15 a0 3e 11 80 	mov    %dx,0x80113ea0
80104ed2:	66 c7 05 a2 3e 11 80 	movw   $0x8,0x80113ea2
80104ed9:	08 00 
80104edb:	c6 05 a4 3e 11 80 00 	movb   $0x0,0x80113ea4
80104ee2:	0f b6 05 a5 3e 11 80 	movzbl 0x80113ea5,%eax
80104ee9:	83 c8 0f             	or     $0xf,%eax
80104eec:	83 e0 ef             	and    $0xffffffef,%eax
80104eef:	83 c8 e0             	or     $0xffffffe0,%eax
80104ef2:	a2 a5 3e 11 80       	mov    %al,0x80113ea5
80104ef7:	c1 ea 10             	shr    $0x10,%edx
80104efa:	66 89 15 a6 3e 11 80 	mov    %dx,0x80113ea6

  initlock(&tickslock, "time");
80104f01:	83 ec 08             	sub    $0x8,%esp
80104f04:	68 49 6d 10 80       	push   $0x80106d49
80104f09:	68 60 3c 11 80       	push   $0x80113c60
80104f0e:	e8 dc eb ff ff       	call   80103aef <initlock>
}
...
80104f1b:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104f1e:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104f24:	b8 a0 3c 11 80       	mov    $0x80113ca0,%eax
80104f29:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104f2d:	c1 e8 10             	shr    $0x10,%eax
80104f30:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104f34:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104f37:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104f3a:	c9                   	leave  
80104f3b:	c3                   	ret    
...
80104f3f:	57                   	push   %edi
80104f40:	56                   	push   %esi
80104f41:	53                   	push   %ebx
80104f42:	83 ec 1c             	sub    $0x1c,%esp
80104f45:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104f48:	8b 43 30             	mov    0x30(%ebx),%eax
80104f4b:	83 f8 40             	cmp    $0x40,%eax
80104f4e:	74 13                	je     80104f63 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104f50:	83 e8 20             	sub    $0x20,%eax
80104f53:	83 f8 1f             	cmp    $0x1f,%eax
80104f56:	0f 87 3a 01 00 00    	ja     80105096 <trap+0x15a>
80104f5c:	ff 24 85 f0 6d 10 80 	jmp    *-0x7fef9210(,%eax,4)
    if(myproc()->killed)
80104f63:	e8 8e e2 ff ff       	call   801031f6 <myproc>
80104f68:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f6c:	75 1f                	jne    80104f8d <trap+0x51>
    myproc()->tf = tf;
80104f6e:	e8 83 e2 ff ff       	call   801031f6 <myproc>
80104f73:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104f76:	e8 6a f0 ff ff       	call   80103fe5 <syscall>
    if(myproc()->killed)
80104f7b:	e8 76 e2 ff ff       	call   801031f6 <myproc>
80104f80:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f84:	74 7e                	je     80105004 <trap+0xc8>
      exit();
80104f86:	e8 17 e6 ff ff       	call   801035a2 <exit>
80104f8b:	eb 77                	jmp    80105004 <trap+0xc8>
      exit();
80104f8d:	e8 10 e6 ff ff       	call   801035a2 <exit>
80104f92:	eb da                	jmp    80104f6e <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104f94:	e8 42 e2 ff ff       	call   801031db <cpuid>
80104f99:	85 c0                	test   %eax,%eax
80104f9b:	74 6f                	je     8010500c <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104f9d:	e8 f7 d3 ff ff       	call   80102399 <lapiceoi>
  }
...
80104fa2:	e8 4f e2 ff ff       	call   801031f6 <myproc>
80104fa7:	85 c0                	test   %eax,%eax
80104fa9:	74 1c                	je     80104fc7 <trap+0x8b>
80104fab:	e8 46 e2 ff ff       	call   801031f6 <myproc>
80104fb0:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104fb4:	74 11                	je     80104fc7 <trap+0x8b>
80104fb6:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104fba:	83 e0 03             	and    $0x3,%eax
80104fbd:	66 83 f8 03          	cmp    $0x3,%ax
80104fc1:	0f 84 62 01 00 00    	je     80105129 <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104fc7:	e8 2a e2 ff ff       	call   801031f6 <myproc>
80104fcc:	85 c0                	test   %eax,%eax
80104fce:	74 0f                	je     80104fdf <trap+0xa3>
80104fd0:	e8 21 e2 ff ff       	call   801031f6 <myproc>
80104fd5:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104fd9:	0f 84 54 01 00 00    	je     80105133 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104fdf:	e8 12 e2 ff ff       	call   801031f6 <myproc>
80104fe4:	85 c0                	test   %eax,%eax
80104fe6:	74 1c                	je     80105004 <trap+0xc8>
80104fe8:	e8 09 e2 ff ff       	call   801031f6 <myproc>
80104fed:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ff1:	74 11                	je     80105004 <trap+0xc8>
80104ff3:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104ff7:	83 e0 03             	and    $0x3,%eax
80104ffa:	66 83 f8 03          	cmp    $0x3,%ax
80104ffe:	0f 84 43 01 00 00    	je     80105147 <trap+0x20b>
    exit();
}
...
8010500f:	68 60 3c 11 80       	push   $0x80113c60
80105014:	e8 12 ec ff ff       	call   80103c2b <acquire>
      ticks++;
80105019:	83 05 a0 44 11 80 01 	addl   $0x1,0x801144a0
      wakeup(&ticks);
80105020:	c7 04 24 a0 44 11 80 	movl   $0x801144a0,(%esp)
80105027:	e8 d3 e7 ff ff       	call   801037ff <wakeup>
      release(&tickslock);
8010502c:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80105033:	e8 58 ec ff ff       	call   80103c90 <release>
80105038:	83 c4 10             	add    $0x10,%esp
8010503b:	e9 5d ff ff ff       	jmp    80104f9d <trap+0x61>
    ideintr();
80105040:	e8 2e cd ff ff       	call   80101d73 <ideintr>
    lapiceoi();
80105045:	e8 4f d3 ff ff       	call   80102399 <lapiceoi>
    break;
8010504a:	e9 53 ff ff ff       	jmp    80104fa2 <trap+0x66>
    kbdintr();
8010504f:	e8 89 d1 ff ff       	call   801021dd <kbdintr>
    lapiceoi();
80105054:	e8 40 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80105059:	e9 44 ff ff ff       	jmp    80104fa2 <trap+0x66>
    uartintr();
8010505e:	e8 05 02 00 00       	call   80105268 <uartintr>
    lapiceoi();
80105063:	e8 31 d3 ff ff       	call   80102399 <lapiceoi>
    break;
80105068:	e9 35 ff ff ff       	jmp    80104fa2 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010506d:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80105070:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105074:	e8 62 e1 ff ff       	call   801031db <cpuid>
80105079:	57                   	push   %edi
8010507a:	0f b7 f6             	movzwl %si,%esi
8010507d:	56                   	push   %esi
8010507e:	50                   	push   %eax
8010507f:	68 54 6d 10 80       	push   $0x80106d54
80105084:	e8 82 b5 ff ff       	call   8010060b <cprintf>
    lapiceoi();
80105089:	e8 0b d3 ff ff       	call   80102399 <lapiceoi>
    break;
8010508e:	83 c4 10             	add    $0x10,%esp
80105091:	e9 0c ff ff ff       	jmp    80104fa2 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80105096:	e8 5b e1 ff ff       	call   801031f6 <myproc>
8010509b:	85 c0                	test   %eax,%eax
8010509d:	74 5f                	je     801050fe <trap+0x1c2>
8010509f:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801050a3:	74 59                	je     801050fe <trap+0x1c2>
...
801050a5:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801050a8:	8b 43 38             	mov    0x38(%ebx),%eax
801050ab:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801050ae:	e8 28 e1 ff ff       	call   801031db <cpuid>
801050b3:	89 45 e0             	mov    %eax,-0x20(%ebp)
801050b6:	8b 53 34             	mov    0x34(%ebx),%edx
801050b9:	89 55 dc             	mov    %edx,-0x24(%ebp)
801050bc:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
801050bf:	e8 32 e1 ff ff       	call   801031f6 <myproc>
801050c4:	8d 48 6c             	lea    0x6c(%eax),%ecx
801050c7:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801050ca:	e8 27 e1 ff ff       	call   801031f6 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801050cf:	57                   	push   %edi
801050d0:	ff 75 e4             	pushl  -0x1c(%ebp)
801050d3:	ff 75 e0             	pushl  -0x20(%ebp)
801050d6:	ff 75 dc             	pushl  -0x24(%ebp)
801050d9:	56                   	push   %esi
801050da:	ff 75 d8             	pushl  -0x28(%ebp)
801050dd:	ff 70 10             	pushl  0x10(%eax)
801050e0:	68 ac 6d 10 80       	push   $0x80106dac
801050e5:	e8 21 b5 ff ff       	call   8010060b <cprintf>
    myproc()->killed = 1;
801050ea:	83 c4 20             	add    $0x20,%esp
801050ed:	e8 04 e1 ff ff       	call   801031f6 <myproc>
801050f2:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801050f9:	e9 a4 fe ff ff       	jmp    80104fa2 <trap+0x66>
801050fe:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105101:	8b 73 38             	mov    0x38(%ebx),%esi
80105104:	e8 d2 e0 ff ff       	call   801031db <cpuid>
80105109:	83 ec 0c             	sub    $0xc,%esp
8010510c:	57                   	push   %edi
8010510d:	56                   	push   %esi
8010510e:	50                   	push   %eax
8010510f:	ff 73 30             	pushl  0x30(%ebx)
80105112:	68 78 6d 10 80       	push   $0x80106d78
80105117:	e8 ef b4 ff ff       	call   8010060b <cprintf>
      panic("trap");
8010511c:	83 c4 14             	add    $0x14,%esp
8010511f:	68 4e 6d 10 80       	push   $0x80106d4e
80105124:	e8 1f b2 ff ff       	call   80100348 <panic>
    exit();
80105129:	e8 74 e4 ff ff       	call   801035a2 <exit>
8010512e:	e9 94 fe ff ff       	jmp    80104fc7 <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105133:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105137:	0f 85 a2 fe ff ff    	jne    80104fdf <trap+0xa3>
    yield();
8010513d:	e8 26 e5 ff ff       	call   80103668 <yield>
80105142:	e9 98 fe ff ff       	jmp    80104fdf <trap+0xa3>
    exit();
80105147:	e8 56 e4 ff ff       	call   801035a2 <exit>
8010514c:	e9 b3 fe ff ff       	jmp    80105004 <trap+0xc8>
...
80105152:	89 e5                	mov    %esp,%ebp
  if(!uart)
80105154:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
8010515b:	74 15                	je     80105172 <uartgetc+0x21>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010515d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105162:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105163:	a8 01                	test   $0x1,%al
80105165:	74 12                	je     80105179 <uartgetc+0x28>
80105167:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105177:	eb f7                	jmp    80105170 <uartgetc+0x1f>
    return -1;
80105179:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010517e:	eb f0                	jmp    80105170 <uartgetc+0x1f>

80105180 <uartputc>:
  if(!uart)
80105180:	83 3d bc 95 10 80 00 	cmpl   $0x0,0x801095bc
80105187:	74 3b                	je     801051c4 <uartputc+0x44>
{
...
80105190:	bb 00 00 00 00       	mov    $0x0,%ebx
80105195:	eb 10                	jmp    801051a7 <uartputc+0x27>
    microdelay(10);
80105197:	83 ec 0c             	sub    $0xc,%esp
8010519a:	6a 0a                	push   $0xa
8010519c:	e8 17 d2 ff ff       	call   801023b8 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801051a1:	83 c3 01             	add    $0x1,%ebx
801051a4:	83 c4 10             	add    $0x10,%esp
801051a7:	83 fb 7f             	cmp    $0x7f,%ebx
801051aa:	7f 0a                	jg     801051b6 <uartputc+0x36>
801051ac:	ba fd 03 00 00       	mov    $0x3fd,%edx
801051b1:	ec                   	in     (%dx),%al
801051b2:	a8 20                	test   $0x20,%al
801051b4:	74 e1                	je     80105197 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801051b6:	8b 45 08             	mov    0x8(%ebp),%eax
801051b9:	ba f8 03 00 00       	mov    $0x3f8,%edx
801051be:	ee                   	out    %al,(%dx)
}
801051bf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801051c2:	c9                   	leave  
801051c3:	c3                   	ret    
801051c4:	f3 c3                	repz ret 
...
801051cb:	b9 00 00 00 00       	mov    $0x0,%ecx
801051d0:	ba fa 03 00 00       	mov    $0x3fa,%edx
801051d5:	89 c8                	mov    %ecx,%eax
801051d7:	ee                   	out    %al,(%dx)
801051d8:	be fb 03 00 00       	mov    $0x3fb,%esi
801051dd:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801051e2:	89 f2                	mov    %esi,%edx
801051e4:	ee                   	out    %al,(%dx)
801051e5:	b8 0c 00 00 00       	mov    $0xc,%eax
801051ea:	ba f8 03 00 00       	mov    $0x3f8,%edx
801051ef:	ee                   	out    %al,(%dx)
801051f0:	bb f9 03 00 00       	mov    $0x3f9,%ebx
801051f5:	89 c8                	mov    %ecx,%eax
801051f7:	89 da                	mov    %ebx,%edx
801051f9:	ee                   	out    %al,(%dx)
801051fa:	b8 03 00 00 00       	mov    $0x3,%eax
801051ff:	89 f2                	mov    %esi,%edx
80105201:	ee                   	out    %al,(%dx)
80105202:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105207:	89 c8                	mov    %ecx,%eax
80105209:	ee                   	out    %al,(%dx)
8010520a:	b8 01 00 00 00       	mov    $0x1,%eax
8010520f:	89 da                	mov    %ebx,%edx
80105211:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105212:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105217:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105218:	3c ff                	cmp    $0xff,%al
8010521a:	74 45                	je     80105261 <uartinit+0x9b>
  uart = 1;
8010521c:	c7 05 bc 95 10 80 01 	movl   $0x1,0x801095bc
80105223:	00 00 00 
80105226:	ba fa 03 00 00       	mov    $0x3fa,%edx
...
80105237:	6a 04                	push   $0x4
80105239:	e8 40 cd ff ff       	call   80101f7e <ioapicenable>
  for(p="xv6...\n"; *p; p++)
8010523e:	83 c4 10             	add    $0x10,%esp
80105241:	bb 70 6e 10 80       	mov    $0x80106e70,%ebx
80105246:	eb 12                	jmp    8010525a <uartinit+0x94>
    uartputc(*p);
80105248:	83 ec 0c             	sub    $0xc,%esp
8010524b:	0f be c0             	movsbl %al,%eax
8010524e:	50                   	push   %eax
8010524f:	e8 2c ff ff ff       	call   80105180 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105254:	83 c3 01             	add    $0x1,%ebx
80105257:	83 c4 10             	add    $0x10,%esp
8010525a:	0f b6 03             	movzbl (%ebx),%eax
8010525d:	84 c0                	test   %al,%al
8010525f:	75 e7                	jne    80105248 <uartinit+0x82>
}
80105261:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105264:	5b                   	pop    %ebx
80105265:	5e                   	pop    %esi
80105266:	5d                   	pop    %ebp
80105267:	c3                   	ret    
...
8010526e:	68 51 51 10 80       	push   $0x80105151
80105273:	e8 c6 b4 ff ff       	call   8010073e <consoleintr>
}
...
8010527f:	6a 00                	push   $0x0
  jmp alltraps
80105281:	e9 be fb ff ff       	jmp    80104e44 <alltraps>
...
80105288:	6a 01                	push   $0x1
  jmp alltraps
8010528a:	e9 b5 fb ff ff       	jmp    80104e44 <alltraps>
...
80105291:	6a 02                	push   $0x2
  jmp alltraps
80105293:	e9 ac fb ff ff       	jmp    80104e44 <alltraps>
...
8010529a:	6a 03                	push   $0x3
  jmp alltraps
8010529c:	e9 a3 fb ff ff       	jmp    80104e44 <alltraps>
...
801052a3:	6a 04                	push   $0x4
  jmp alltraps
801052a5:	e9 9a fb ff ff       	jmp    80104e44 <alltraps>
...
801052ac:	6a 05                	push   $0x5
  jmp alltraps
801052ae:	e9 91 fb ff ff       	jmp    80104e44 <alltraps>
...
801052b5:	6a 06                	push   $0x6
  jmp alltraps
801052b7:	e9 88 fb ff ff       	jmp    80104e44 <alltraps>
...
801052be:	6a 07                	push   $0x7
  jmp alltraps
801052c0:	e9 7f fb ff ff       	jmp    80104e44 <alltraps>
...
801052c5:	6a 08                	push   $0x8
  jmp alltraps
801052c7:	e9 78 fb ff ff       	jmp    80104e44 <alltraps>
...
801052ce:	6a 09                	push   $0x9
  jmp alltraps
801052d0:	e9 6f fb ff ff       	jmp    80104e44 <alltraps>
...
801052dc:	6a 0b                	push   $0xb
  jmp alltraps
801052de:	e9 61 fb ff ff       	jmp    80104e44 <alltraps>
...
801052e3:	6a 0c                	push   $0xc
  jmp alltraps
801052e5:	e9 5a fb ff ff       	jmp    80104e44 <alltraps>
...
801052ea:	6a 0d                	push   $0xd
  jmp alltraps
801052ec:	e9 53 fb ff ff       	jmp    80104e44 <alltraps>
...
801052f1:	6a 0e                	push   $0xe
  jmp alltraps
801052f3:	e9 4c fb ff ff       	jmp    80104e44 <alltraps>
...
801052fa:	6a 0f                	push   $0xf
  jmp alltraps
801052fc:	e9 43 fb ff ff       	jmp    80104e44 <alltraps>
...
80105303:	6a 10                	push   $0x10
  jmp alltraps
80105305:	e9 3a fb ff ff       	jmp    80104e44 <alltraps>
...
8010530a:	6a 11                	push   $0x11
  jmp alltraps
8010530c:	e9 33 fb ff ff       	jmp    80104e44 <alltraps>
...
80105313:	6a 12                	push   $0x12
  jmp alltraps
80105315:	e9 2a fb ff ff       	jmp    80104e44 <alltraps>
...
8010531c:	6a 13                	push   $0x13
  jmp alltraps
8010531e:	e9 21 fb ff ff       	jmp    80104e44 <alltraps>
...
80105325:	6a 14                	push   $0x14
  jmp alltraps
80105327:	e9 18 fb ff ff       	jmp    80104e44 <alltraps>
...
8010532e:	6a 15                	push   $0x15
  jmp alltraps
80105330:	e9 0f fb ff ff       	jmp    80104e44 <alltraps>
...
80105340:	6a 17                	push   $0x17
  jmp alltraps
80105342:	e9 fd fa ff ff       	jmp    80104e44 <alltraps>
...
80105349:	6a 18                	push   $0x18
  jmp alltraps
8010534b:	e9 f4 fa ff ff       	jmp    80104e44 <alltraps>
...
80105352:	6a 19                	push   $0x19
  jmp alltraps
80105354:	e9 eb fa ff ff       	jmp    80104e44 <alltraps>
...
8010535b:	6a 1a                	push   $0x1a
  jmp alltraps
8010535d:	e9 e2 fa ff ff       	jmp    80104e44 <alltraps>
...
80105364:	6a 1b                	push   $0x1b
  jmp alltraps
80105366:	e9 d9 fa ff ff       	jmp    80104e44 <alltraps>
...
8010536d:	6a 1c                	push   $0x1c
  jmp alltraps
8010536f:	e9 d0 fa ff ff       	jmp    80104e44 <alltraps>
...
80105376:	6a 1d                	push   $0x1d
  jmp alltraps
80105378:	e9 c7 fa ff ff       	jmp    80104e44 <alltraps>
...
8010537f:	6a 1e                	push   $0x1e
  jmp alltraps
80105381:	e9 be fa ff ff       	jmp    80104e44 <alltraps>
...
80105388:	6a 1f                	push   $0x1f
  jmp alltraps
8010538a:	e9 b5 fa ff ff       	jmp    80104e44 <alltraps>
...
80105391:	6a 20                	push   $0x20
  jmp alltraps
80105393:	e9 ac fa ff ff       	jmp    80104e44 <alltraps>
...
8010539a:	6a 21                	push   $0x21
  jmp alltraps
8010539c:	e9 a3 fa ff ff       	jmp    80104e44 <alltraps>
...
801053a3:	6a 22                	push   $0x22
  jmp alltraps
801053a5:	e9 9a fa ff ff       	jmp    80104e44 <alltraps>
...
801053ac:	6a 23                	push   $0x23
  jmp alltraps
801053ae:	e9 91 fa ff ff       	jmp    80104e44 <alltraps>
...
801053b5:	6a 24                	push   $0x24
  jmp alltraps
801053b7:	e9 88 fa ff ff       	jmp    80104e44 <alltraps>
...
801053be:	6a 25                	push   $0x25
  jmp alltraps
801053c0:	e9 7f fa ff ff       	jmp    80104e44 <alltraps>
...
801053c7:	6a 26                	push   $0x26
  jmp alltraps
801053c9:	e9 76 fa ff ff       	jmp    80104e44 <alltraps>
...
801053d0:	6a 27                	push   $0x27
  jmp alltraps
801053d2:	e9 6d fa ff ff       	jmp    80104e44 <alltraps>
...
801053d9:	6a 28                	push   $0x28
  jmp alltraps
801053db:	e9 64 fa ff ff       	jmp    80104e44 <alltraps>
...
801053e2:	6a 29                	push   $0x29
  jmp alltraps
801053e4:	e9 5b fa ff ff       	jmp    80104e44 <alltraps>
...
801053eb:	6a 2a                	push   $0x2a
  jmp alltraps
801053ed:	e9 52 fa ff ff       	jmp    80104e44 <alltraps>
...
801053f4:	6a 2b                	push   $0x2b
  jmp alltraps
801053f6:	e9 49 fa ff ff       	jmp    80104e44 <alltraps>
...
801053fd:	6a 2c                	push   $0x2c
  jmp alltraps
801053ff:	e9 40 fa ff ff       	jmp    80104e44 <alltraps>
...
80105406:	6a 2d                	push   $0x2d
  jmp alltraps
80105408:	e9 37 fa ff ff       	jmp    80104e44 <alltraps>
...
8010540f:	6a 2e                	push   $0x2e
  jmp alltraps
80105411:	e9 2e fa ff ff       	jmp    80104e44 <alltraps>
...
80105418:	6a 2f                	push   $0x2f
  jmp alltraps
8010541a:	e9 25 fa ff ff       	jmp    80104e44 <alltraps>
...
80105421:	6a 30                	push   $0x30
  jmp alltraps
80105423:	e9 1c fa ff ff       	jmp    80104e44 <alltraps>
...
8010542a:	6a 31                	push   $0x31
  jmp alltraps
8010542c:	e9 13 fa ff ff       	jmp    80104e44 <alltraps>
...
80105433:	6a 32                	push   $0x32
  jmp alltraps
80105435:	e9 0a fa ff ff       	jmp    80104e44 <alltraps>
...
8010543c:	6a 33                	push   $0x33
  jmp alltraps
8010543e:	e9 01 fa ff ff       	jmp    80104e44 <alltraps>
...
80105445:	6a 34                	push   $0x34
  jmp alltraps
80105447:	e9 f8 f9 ff ff       	jmp    80104e44 <alltraps>
...
8010544e:	6a 35                	push   $0x35
  jmp alltraps
80105450:	e9 ef f9 ff ff       	jmp    80104e44 <alltraps>
...
80105457:	6a 36                	push   $0x36
  jmp alltraps
80105459:	e9 e6 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105460:	6a 37                	push   $0x37
  jmp alltraps
80105462:	e9 dd f9 ff ff       	jmp    80104e44 <alltraps>
...
80105469:	6a 38                	push   $0x38
  jmp alltraps
8010546b:	e9 d4 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105472:	6a 39                	push   $0x39
  jmp alltraps
80105474:	e9 cb f9 ff ff       	jmp    80104e44 <alltraps>
...
8010547b:	6a 3a                	push   $0x3a
  jmp alltraps
8010547d:	e9 c2 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105484:	6a 3b                	push   $0x3b
  jmp alltraps
80105486:	e9 b9 f9 ff ff       	jmp    80104e44 <alltraps>
...
8010548d:	6a 3c                	push   $0x3c
  jmp alltraps
8010548f:	e9 b0 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105496:	6a 3d                	push   $0x3d
  jmp alltraps
80105498:	e9 a7 f9 ff ff       	jmp    80104e44 <alltraps>
...
8010549f:	6a 3e                	push   $0x3e
  jmp alltraps
801054a1:	e9 9e f9 ff ff       	jmp    80104e44 <alltraps>
...
801054a8:	6a 3f                	push   $0x3f
  jmp alltraps
801054aa:	e9 95 f9 ff ff       	jmp    80104e44 <alltraps>
...
801054b1:	6a 40                	push   $0x40
  jmp alltraps
801054b3:	e9 8c f9 ff ff       	jmp    80104e44 <alltraps>
...
801054ba:	6a 41                	push   $0x41
  jmp alltraps
801054bc:	e9 83 f9 ff ff       	jmp    80104e44 <alltraps>
...
801054c3:	6a 42                	push   $0x42
  jmp alltraps
801054c5:	e9 7a f9 ff ff       	jmp    80104e44 <alltraps>
...
801054cc:	6a 43                	push   $0x43
  jmp alltraps
801054ce:	e9 71 f9 ff ff       	jmp    80104e44 <alltraps>
...
801054d5:	6a 44                	push   $0x44
  jmp alltraps
801054d7:	e9 68 f9 ff ff       	jmp    80104e44 <alltraps>
...
801054de:	6a 45                	push   $0x45
  jmp alltraps
801054e0:	e9 5f f9 ff ff       	jmp    80104e44 <alltraps>
...
801054e7:	6a 46                	push   $0x46
  jmp alltraps
801054e9:	e9 56 f9 ff ff       	jmp    80104e44 <alltraps>
...
801054f0:	6a 47                	push   $0x47
  jmp alltraps
801054f2:	e9 4d f9 ff ff       	jmp    80104e44 <alltraps>
...
801054f9:	6a 48                	push   $0x48
  jmp alltraps
801054fb:	e9 44 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105502:	6a 49                	push   $0x49
  jmp alltraps
80105504:	e9 3b f9 ff ff       	jmp    80104e44 <alltraps>
...
8010550b:	6a 4a                	push   $0x4a
  jmp alltraps
8010550d:	e9 32 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105514:	6a 4b                	push   $0x4b
  jmp alltraps
80105516:	e9 29 f9 ff ff       	jmp    80104e44 <alltraps>
...
8010551d:	6a 4c                	push   $0x4c
  jmp alltraps
8010551f:	e9 20 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105526:	6a 4d                	push   $0x4d
  jmp alltraps
80105528:	e9 17 f9 ff ff       	jmp    80104e44 <alltraps>
...
8010552f:	6a 4e                	push   $0x4e
  jmp alltraps
80105531:	e9 0e f9 ff ff       	jmp    80104e44 <alltraps>
...
80105538:	6a 4f                	push   $0x4f
  jmp alltraps
8010553a:	e9 05 f9 ff ff       	jmp    80104e44 <alltraps>
...
80105541:	6a 50                	push   $0x50
  jmp alltraps
80105543:	e9 fc f8 ff ff       	jmp    80104e44 <alltraps>
...
8010554a:	6a 51                	push   $0x51
  jmp alltraps
8010554c:	e9 f3 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105553:	6a 52                	push   $0x52
  jmp alltraps
80105555:	e9 ea f8 ff ff       	jmp    80104e44 <alltraps>
...
8010555c:	6a 53                	push   $0x53
  jmp alltraps
8010555e:	e9 e1 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105565:	6a 54                	push   $0x54
  jmp alltraps
80105567:	e9 d8 f8 ff ff       	jmp    80104e44 <alltraps>
...
8010556e:	6a 55                	push   $0x55
  jmp alltraps
80105570:	e9 cf f8 ff ff       	jmp    80104e44 <alltraps>
...
80105577:	6a 56                	push   $0x56
  jmp alltraps
80105579:	e9 c6 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105580:	6a 57                	push   $0x57
  jmp alltraps
80105582:	e9 bd f8 ff ff       	jmp    80104e44 <alltraps>
...
80105589:	6a 58                	push   $0x58
  jmp alltraps
8010558b:	e9 b4 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105592:	6a 59                	push   $0x59
  jmp alltraps
80105594:	e9 ab f8 ff ff       	jmp    80104e44 <alltraps>
...
8010559b:	6a 5a                	push   $0x5a
  jmp alltraps
8010559d:	e9 a2 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055a4:	6a 5b                	push   $0x5b
  jmp alltraps
801055a6:	e9 99 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055ad:	6a 5c                	push   $0x5c
  jmp alltraps
801055af:	e9 90 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055b6:	6a 5d                	push   $0x5d
  jmp alltraps
801055b8:	e9 87 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055bf:	6a 5e                	push   $0x5e
  jmp alltraps
801055c1:	e9 7e f8 ff ff       	jmp    80104e44 <alltraps>
...
801055c8:	6a 5f                	push   $0x5f
  jmp alltraps
801055ca:	e9 75 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055d1:	6a 60                	push   $0x60
  jmp alltraps
801055d3:	e9 6c f8 ff ff       	jmp    80104e44 <alltraps>
...
801055da:	6a 61                	push   $0x61
  jmp alltraps
801055dc:	e9 63 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055e3:	6a 62                	push   $0x62
  jmp alltraps
801055e5:	e9 5a f8 ff ff       	jmp    80104e44 <alltraps>
...
801055ec:	6a 63                	push   $0x63
  jmp alltraps
801055ee:	e9 51 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055f5:	6a 64                	push   $0x64
  jmp alltraps
801055f7:	e9 48 f8 ff ff       	jmp    80104e44 <alltraps>
...
801055fe:	6a 65                	push   $0x65
  jmp alltraps
80105600:	e9 3f f8 ff ff       	jmp    80104e44 <alltraps>
...
80105607:	6a 66                	push   $0x66
  jmp alltraps
80105609:	e9 36 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105610:	6a 67                	push   $0x67
  jmp alltraps
80105612:	e9 2d f8 ff ff       	jmp    80104e44 <alltraps>
...
80105619:	6a 68                	push   $0x68
  jmp alltraps
8010561b:	e9 24 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105622:	6a 69                	push   $0x69
  jmp alltraps
80105624:	e9 1b f8 ff ff       	jmp    80104e44 <alltraps>
...
8010562b:	6a 6a                	push   $0x6a
  jmp alltraps
8010562d:	e9 12 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105634:	6a 6b                	push   $0x6b
  jmp alltraps
80105636:	e9 09 f8 ff ff       	jmp    80104e44 <alltraps>
...
8010563d:	6a 6c                	push   $0x6c
  jmp alltraps
8010563f:	e9 00 f8 ff ff       	jmp    80104e44 <alltraps>
...
80105646:	6a 6d                	push   $0x6d
  jmp alltraps
80105648:	e9 f7 f7 ff ff       	jmp    80104e44 <alltraps>
...
8010564f:	6a 6e                	push   $0x6e
  jmp alltraps
80105651:	e9 ee f7 ff ff       	jmp    80104e44 <alltraps>
...
80105658:	6a 6f                	push   $0x6f
  jmp alltraps
8010565a:	e9 e5 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105661:	6a 70                	push   $0x70
  jmp alltraps
80105663:	e9 dc f7 ff ff       	jmp    80104e44 <alltraps>
...
8010566a:	6a 71                	push   $0x71
  jmp alltraps
8010566c:	e9 d3 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105673:	6a 72                	push   $0x72
  jmp alltraps
80105675:	e9 ca f7 ff ff       	jmp    80104e44 <alltraps>
...
8010567c:	6a 73                	push   $0x73
  jmp alltraps
8010567e:	e9 c1 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105685:	6a 74                	push   $0x74
  jmp alltraps
80105687:	e9 b8 f7 ff ff       	jmp    80104e44 <alltraps>
...
8010568e:	6a 75                	push   $0x75
  jmp alltraps
80105690:	e9 af f7 ff ff       	jmp    80104e44 <alltraps>
...
80105697:	6a 76                	push   $0x76
  jmp alltraps
80105699:	e9 a6 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056a0:	6a 77                	push   $0x77
  jmp alltraps
801056a2:	e9 9d f7 ff ff       	jmp    80104e44 <alltraps>
...
801056a9:	6a 78                	push   $0x78
  jmp alltraps
801056ab:	e9 94 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056b2:	6a 79                	push   $0x79
  jmp alltraps
801056b4:	e9 8b f7 ff ff       	jmp    80104e44 <alltraps>
...
801056bb:	6a 7a                	push   $0x7a
  jmp alltraps
801056bd:	e9 82 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056c4:	6a 7b                	push   $0x7b
  jmp alltraps
801056c6:	e9 79 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056cd:	6a 7c                	push   $0x7c
  jmp alltraps
801056cf:	e9 70 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056d6:	6a 7d                	push   $0x7d
  jmp alltraps
801056d8:	e9 67 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056df:	6a 7e                	push   $0x7e
  jmp alltraps
801056e1:	e9 5e f7 ff ff       	jmp    80104e44 <alltraps>
...
801056e8:	6a 7f                	push   $0x7f
  jmp alltraps
801056ea:	e9 55 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056f1:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801056f6:	e9 49 f7 ff ff       	jmp    80104e44 <alltraps>
...
801056fd:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105702:	e9 3d f7 ff ff       	jmp    80104e44 <alltraps>
...
80105709:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010570e:	e9 31 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105715:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010571a:	e9 25 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105721:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105726:	e9 19 f7 ff ff       	jmp    80104e44 <alltraps>
...
8010572d:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80105732:	e9 0d f7 ff ff       	jmp    80104e44 <alltraps>
...
80105739:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010573e:	e9 01 f7 ff ff       	jmp    80104e44 <alltraps>
...
80105745:	68 87 00 00 00       	push   $0x87
  jmp alltraps
8010574a:	e9 f5 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105751:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105756:	e9 e9 f6 ff ff       	jmp    80104e44 <alltraps>
...
8010575d:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80105762:	e9 dd f6 ff ff       	jmp    80104e44 <alltraps>
...
80105769:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010576e:	e9 d1 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105775:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
8010577a:	e9 c5 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105781:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105786:	e9 b9 f6 ff ff       	jmp    80104e44 <alltraps>
...
8010578d:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105792:	e9 ad f6 ff ff       	jmp    80104e44 <alltraps>
...
80105799:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
8010579e:	e9 a1 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057a5:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801057aa:	e9 95 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057b1:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801057b6:	e9 89 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057bd:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801057c2:	e9 7d f6 ff ff       	jmp    80104e44 <alltraps>
...
801057c9:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801057ce:	e9 71 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057d5:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801057da:	e9 65 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057e1:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801057e6:	e9 59 f6 ff ff       	jmp    80104e44 <alltraps>
...
801057ed:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801057f2:	e9 4d f6 ff ff       	jmp    80104e44 <alltraps>
...
801057f9:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801057fe:	e9 41 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105805:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010580a:	e9 35 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105811:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105816:	e9 29 f6 ff ff       	jmp    80104e44 <alltraps>
...
8010581d:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80105822:	e9 1d f6 ff ff       	jmp    80104e44 <alltraps>
...
80105829:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010582e:	e9 11 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105835:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
8010583a:	e9 05 f6 ff ff       	jmp    80104e44 <alltraps>
...
80105841:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105846:	e9 f9 f5 ff ff       	jmp    80104e44 <alltraps>
...
8010584d:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80105852:	e9 ed f5 ff ff       	jmp    80104e44 <alltraps>
...
80105859:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010585e:	e9 e1 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105865:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
8010586a:	e9 d5 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105871:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105876:	e9 c9 f5 ff ff       	jmp    80104e44 <alltraps>
...
8010587d:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105882:	e9 bd f5 ff ff       	jmp    80104e44 <alltraps>
...
80105889:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010588e:	e9 b1 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105895:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010589a:	e9 a5 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058a1:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801058a6:	e9 99 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058ad:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801058b2:	e9 8d f5 ff ff       	jmp    80104e44 <alltraps>
...
801058b9:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801058be:	e9 81 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058c5:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801058ca:	e9 75 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058d1:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801058d6:	e9 69 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058dd:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801058e2:	e9 5d f5 ff ff       	jmp    80104e44 <alltraps>
...
801058e9:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801058ee:	e9 51 f5 ff ff       	jmp    80104e44 <alltraps>
...
801058f5:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801058fa:	e9 45 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105901:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105906:	e9 39 f5 ff ff       	jmp    80104e44 <alltraps>
...
8010590d:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105912:	e9 2d f5 ff ff       	jmp    80104e44 <alltraps>
...
80105919:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010591e:	e9 21 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105925:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
8010592a:	e9 15 f5 ff ff       	jmp    80104e44 <alltraps>
...
80105931:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105936:	e9 09 f5 ff ff       	jmp    80104e44 <alltraps>
...
8010593d:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80105942:	e9 fd f4 ff ff       	jmp    80104e44 <alltraps>
...
80105949:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010594e:	e9 f1 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105955:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
8010595a:	e9 e5 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105961:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105966:	e9 d9 f4 ff ff       	jmp    80104e44 <alltraps>
...
8010596d:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80105972:	e9 cd f4 ff ff       	jmp    80104e44 <alltraps>
...
80105979:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010597e:	e9 c1 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105985:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010598a:	e9 b5 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105991:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105996:	e9 a9 f4 ff ff       	jmp    80104e44 <alltraps>
...
8010599d:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801059a2:	e9 9d f4 ff ff       	jmp    80104e44 <alltraps>
...
801059a9:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801059ae:	e9 91 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059b5:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801059ba:	e9 85 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059c1:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801059c6:	e9 79 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059cd:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801059d2:	e9 6d f4 ff ff       	jmp    80104e44 <alltraps>
...
801059d9:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801059de:	e9 61 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059e5:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801059ea:	e9 55 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059f1:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801059f6:	e9 49 f4 ff ff       	jmp    80104e44 <alltraps>
...
801059fd:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105a02:	e9 3d f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a09:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105a0e:	e9 31 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a15:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105a1a:	e9 25 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a21:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105a26:	e9 19 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a2d:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80105a32:	e9 0d f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a39:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80105a3e:	e9 01 f4 ff ff       	jmp    80104e44 <alltraps>
...
80105a45:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105a4a:	e9 f5 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a51:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105a56:	e9 e9 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a5d:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80105a62:	e9 dd f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a69:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80105a6e:	e9 d1 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a75:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105a7a:	e9 c5 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a81:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105a86:	e9 b9 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a8d:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105a92:	e9 ad f3 ff ff       	jmp    80104e44 <alltraps>
...
80105a99:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105a9e:	e9 a1 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105aa5:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105aaa:	e9 95 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105ab1:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105ab6:	e9 89 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105abd:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105ac2:	e9 7d f3 ff ff       	jmp    80104e44 <alltraps>
...
80105ac9:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105ace:	e9 71 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105ad5:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105ada:	e9 65 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105ae1:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105ae6:	e9 59 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105aed:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105af2:	e9 4d f3 ff ff       	jmp    80104e44 <alltraps>
...
80105af9:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105afe:	e9 41 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b05:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105b0a:	e9 35 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b11:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105b16:	e9 29 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b1d:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105b22:	e9 1d f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b29:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105b2e:	e9 11 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b35:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105b3a:	e9 05 f3 ff ff       	jmp    80104e44 <alltraps>
...
80105b41:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105b46:	e9 f9 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b4d:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105b52:	e9 ed f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b59:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105b5e:	e9 e1 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b65:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105b6a:	e9 d5 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b71:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105b76:	e9 c9 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b7d:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105b82:	e9 bd f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b89:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105b8e:	e9 b1 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105b95:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105b9a:	e9 a5 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105ba1:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105ba6:	e9 99 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bad:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105bb2:	e9 8d f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bb9:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105bbe:	e9 81 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bc5:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105bca:	e9 75 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bd1:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105bd6:	e9 69 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bdd:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105be2:	e9 5d f2 ff ff       	jmp    80104e44 <alltraps>
...
80105be9:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105bee:	e9 51 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105bf5:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105bfa:	e9 45 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c01:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105c06:	e9 39 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c0d:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105c12:	e9 2d f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c19:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105c1e:	e9 21 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c25:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105c2a:	e9 15 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c31:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105c36:	e9 09 f2 ff ff       	jmp    80104e44 <alltraps>
...
80105c3d:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105c42:	e9 fd f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c49:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105c4e:	e9 f1 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c55:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105c5a:	e9 e5 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c61:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105c66:	e9 d9 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c6d:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105c72:	e9 cd f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c79:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105c7e:	e9 c1 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c85:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105c8a:	e9 b5 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c91:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105c96:	e9 a9 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105c9d:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105ca2:	e9 9d f1 ff ff       	jmp    80104e44 <alltraps>
...
80105ca9:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105cae:	e9 91 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105cb5:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105cba:	e9 85 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105cc1:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105cc6:	e9 79 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105ccd:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105cd2:	e9 6d f1 ff ff       	jmp    80104e44 <alltraps>
...
80105cd9:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105cde:	e9 61 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105ce5:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105cea:	e9 55 f1 ff ff       	jmp    80104e44 <alltraps>
...
80105cf8:	89 d6                	mov    %edx,%esi
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105cfa:	c1 ea 16             	shr    $0x16,%edx
80105cfd:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105d00:	8b 1f                	mov    (%edi),%ebx
80105d02:	f6 c3 01             	test   $0x1,%bl
80105d05:	74 22                	je     80105d29 <walkpgdir+0x3a>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105d07:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105d0d:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80105d13:	c1 ee 0c             	shr    $0xc,%esi
80105d16:	81 e6 ff 03 00 00    	and    $0x3ff,%esi
80105d1c:	8d 1c b3             	lea    (%ebx,%esi,4),%ebx
}
80105d1f:	89 d8                	mov    %ebx,%eax
...
80105d2b:	74 2b                	je     80105d58 <walkpgdir+0x69>
80105d2d:	e8 89 c3 ff ff       	call   801020bb <kalloc>
80105d32:	89 c3                	mov    %eax,%ebx
80105d34:	85 c0                	test   %eax,%eax
80105d36:	74 e7                	je     80105d1f <walkpgdir+0x30>
    memset(pgtab, 0, PGSIZE);
80105d38:	83 ec 04             	sub    $0x4,%esp
80105d3b:	68 00 10 00 00       	push   $0x1000
80105d40:	6a 00                	push   $0x0
80105d42:	50                   	push   %eax
80105d43:	e8 8f df ff ff       	call   80103cd7 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105d48:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105d4e:	83 c8 07             	or     $0x7,%eax
80105d51:	89 07                	mov    %eax,(%edi)
80105d53:	83 c4 10             	add    $0x10,%esp
80105d56:	eb bb                	jmp    80105d13 <walkpgdir+0x24>
      return 0;
80105d58:	bb 00 00 00 00       	mov    $0x0,%ebx
80105d5d:	eb c0                	jmp    80105d1f <walkpgdir+0x30>
...
80105d65:	83 ec 1c             	sub    $0x1c,%esp
80105d68:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105d6b:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105d6e:	89 d3                	mov    %edx,%ebx
80105d70:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105d76:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105d7a:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d80:	b9 01 00 00 00       	mov    $0x1,%ecx
80105d85:	89 da                	mov    %ebx,%edx
80105d87:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d8a:	e8 60 ff ff ff       	call   80105cef <walkpgdir>
80105d8f:	85 c0                	test   %eax,%eax
80105d91:	74 2e                	je     80105dc1 <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105d93:	f6 00 01             	testb  $0x1,(%eax)
80105d96:	75 1c                	jne    80105db4 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105d98:	89 f2                	mov    %esi,%edx
80105d9a:	0b 55 0c             	or     0xc(%ebp),%edx
80105d9d:	83 ca 01             	or     $0x1,%edx
80105da0:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105da2:	39 fb                	cmp    %edi,%ebx
80105da4:	74 28                	je     80105dce <mappages+0x6f>
      break;
    a += PGSIZE;
80105da6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105dac:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105db2:	eb cc                	jmp    80105d80 <mappages+0x21>
      panic("remap");
80105db4:	83 ec 0c             	sub    $0xc,%esp
80105db7:	68 78 6e 10 80       	push   $0x80106e78
80105dbc:	e8 87 a5 ff ff       	call   80100348 <panic>
      return -1;
...
80105dd3:	eb f1                	jmp    80105dc6 <mappages+0x67>
...
80105dd9:	83 ec 14             	sub    $0x14,%esp
  c = &cpus[cpuid()];
80105ddc:	e8 fa d3 ff ff       	call   801031db <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105de1:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80105de7:	66 c7 80 f8 17 11 80 	movw   $0xffff,-0x7feee808(%eax)
80105dee:	ff ff 
80105df0:	66 c7 80 fa 17 11 80 	movw   $0x0,-0x7feee806(%eax)
80105df7:	00 00 
80105df9:	c6 80 fc 17 11 80 00 	movb   $0x0,-0x7feee804(%eax)
80105e00:	0f b6 88 fd 17 11 80 	movzbl -0x7feee803(%eax),%ecx
80105e07:	83 e1 f0             	and    $0xfffffff0,%ecx
80105e0a:	83 c9 1a             	or     $0x1a,%ecx
80105e0d:	83 e1 9f             	and    $0xffffff9f,%ecx
80105e10:	83 c9 80             	or     $0xffffff80,%ecx
80105e13:	88 88 fd 17 11 80    	mov    %cl,-0x7feee803(%eax)
80105e19:	0f b6 88 fe 17 11 80 	movzbl -0x7feee802(%eax),%ecx
80105e20:	83 c9 0f             	or     $0xf,%ecx
80105e23:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e26:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e29:	88 88 fe 17 11 80    	mov    %cl,-0x7feee802(%eax)
80105e2f:	c6 80 ff 17 11 80 00 	movb   $0x0,-0x7feee801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105e36:	66 c7 80 00 18 11 80 	movw   $0xffff,-0x7feee800(%eax)
80105e3d:	ff ff 
80105e3f:	66 c7 80 02 18 11 80 	movw   $0x0,-0x7feee7fe(%eax)
80105e46:	00 00 
80105e48:	c6 80 04 18 11 80 00 	movb   $0x0,-0x7feee7fc(%eax)
80105e4f:	0f b6 88 05 18 11 80 	movzbl -0x7feee7fb(%eax),%ecx
80105e56:	83 e1 f0             	and    $0xfffffff0,%ecx
80105e59:	83 c9 12             	or     $0x12,%ecx
80105e5c:	83 e1 9f             	and    $0xffffff9f,%ecx
80105e5f:	83 c9 80             	or     $0xffffff80,%ecx
80105e62:	88 88 05 18 11 80    	mov    %cl,-0x7feee7fb(%eax)
80105e68:	0f b6 88 06 18 11 80 	movzbl -0x7feee7fa(%eax),%ecx
80105e6f:	83 c9 0f             	or     $0xf,%ecx
80105e72:	83 e1 cf             	and    $0xffffffcf,%ecx
80105e75:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e78:	88 88 06 18 11 80    	mov    %cl,-0x7feee7fa(%eax)
80105e7e:	c6 80 07 18 11 80 00 	movb   $0x0,-0x7feee7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105e85:	66 c7 80 08 18 11 80 	movw   $0xffff,-0x7feee7f8(%eax)
80105e8c:	ff ff 
80105e8e:	66 c7 80 0a 18 11 80 	movw   $0x0,-0x7feee7f6(%eax)
80105e95:	00 00 
80105e97:	c6 80 0c 18 11 80 00 	movb   $0x0,-0x7feee7f4(%eax)
80105e9e:	c6 80 0d 18 11 80 fa 	movb   $0xfa,-0x7feee7f3(%eax)
80105ea5:	0f b6 88 0e 18 11 80 	movzbl -0x7feee7f2(%eax),%ecx
80105eac:	83 c9 0f             	or     $0xf,%ecx
80105eaf:	83 e1 cf             	and    $0xffffffcf,%ecx
80105eb2:	83 c9 c0             	or     $0xffffffc0,%ecx
80105eb5:	88 88 0e 18 11 80    	mov    %cl,-0x7feee7f2(%eax)
80105ebb:	c6 80 0f 18 11 80 00 	movb   $0x0,-0x7feee7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105ec2:	66 c7 80 10 18 11 80 	movw   $0xffff,-0x7feee7f0(%eax)
80105ec9:	ff ff 
80105ecb:	66 c7 80 12 18 11 80 	movw   $0x0,-0x7feee7ee(%eax)
80105ed2:	00 00 
80105ed4:	c6 80 14 18 11 80 00 	movb   $0x0,-0x7feee7ec(%eax)
80105edb:	c6 80 15 18 11 80 f2 	movb   $0xf2,-0x7feee7eb(%eax)
80105ee2:	0f b6 88 16 18 11 80 	movzbl -0x7feee7ea(%eax),%ecx
80105ee9:	83 c9 0f             	or     $0xf,%ecx
80105eec:	83 e1 cf             	and    $0xffffffcf,%ecx
80105eef:	83 c9 c0             	or     $0xffffffc0,%ecx
80105ef2:	88 88 16 18 11 80    	mov    %cl,-0x7feee7ea(%eax)
80105ef8:	c6 80 17 18 11 80 00 	movb   $0x0,-0x7feee7e9(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105eff:	05 f0 17 11 80       	add    $0x801117f0,%eax
  pd[0] = size-1;
80105f04:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105f0a:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105f0e:	c1 e8 10             	shr    $0x10,%eax
80105f11:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105f15:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105f18:	0f 01 10             	lgdtl  (%eax)
}
80105f1b:	83 c4 14             	add    $0x14,%esp
80105f1e:	5b                   	pop    %ebx
80105f1f:	5d                   	pop    %ebp
80105f20:	c3                   	ret    
...
80105f24:	a1 a4 44 11 80       	mov    0x801144a4,%eax
80105f29:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105f39:	83 ec 1c             	sub    $0x1c,%esp
80105f3c:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105f3f:	85 f6                	test   %esi,%esi
80105f41:	0f 84 dd 00 00 00    	je     80106024 <switchuvm+0xf1>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105f47:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105f4b:	0f 84 e0 00 00 00    	je     80106031 <switchuvm+0xfe>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105f51:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105f55:	0f 84 e3 00 00 00    	je     8010603e <switchuvm+0x10b>
    panic("switchuvm: no pgdir");

  pushcli();
80105f5b:	e8 ee db ff ff       	call   80103b4e <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105f60:	e8 1a d2 ff ff       	call   8010317f <mycpu>
80105f65:	89 c3                	mov    %eax,%ebx
80105f67:	e8 13 d2 ff ff       	call   8010317f <mycpu>
80105f6c:	8d 78 08             	lea    0x8(%eax),%edi
80105f6f:	e8 0b d2 ff ff       	call   8010317f <mycpu>
80105f74:	83 c0 08             	add    $0x8,%eax
80105f77:	c1 e8 10             	shr    $0x10,%eax
80105f7a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105f7d:	e8 fd d1 ff ff       	call   8010317f <mycpu>
80105f82:	83 c0 08             	add    $0x8,%eax
80105f85:	c1 e8 18             	shr    $0x18,%eax
80105f88:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105f8f:	67 00 
80105f91:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80105f98:	0f b6 4d e4          	movzbl -0x1c(%ebp),%ecx
80105f9c:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80105fa2:	0f b6 93 9d 00 00 00 	movzbl 0x9d(%ebx),%edx
80105fa9:	83 e2 f0             	and    $0xfffffff0,%edx
80105fac:	83 ca 19             	or     $0x19,%edx
80105faf:	83 e2 9f             	and    $0xffffff9f,%edx
80105fb2:	83 ca 80             	or     $0xffffff80,%edx
80105fb5:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105fbb:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105fc2:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105fc8:	e8 b2 d1 ff ff       	call   8010317f <mycpu>
80105fcd:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80105fd4:	83 e2 ef             	and    $0xffffffef,%edx
80105fd7:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105fdd:	e8 9d d1 ff ff       	call   8010317f <mycpu>
80105fe2:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105fe8:	8b 5e 08             	mov    0x8(%esi),%ebx
80105feb:	e8 8f d1 ff ff       	call   8010317f <mycpu>
80105ff0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80105ff6:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105ff9:	e8 81 d1 ff ff       	call   8010317f <mycpu>
80105ffe:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106004:	b8 28 00 00 00       	mov    $0x28,%eax
80106009:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
8010600c:	8b 46 04             	mov    0x4(%esi),%eax
8010600f:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106014:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80106017:	e8 6f db ff ff       	call   80103b8b <popcli>
}
8010601c:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010601f:	5b                   	pop    %ebx
80106020:	5e                   	pop    %esi
80106021:	5f                   	pop    %edi
80106022:	5d                   	pop    %ebp
...
80106027:	68 7e 6e 10 80       	push   $0x80106e7e
8010602c:	e8 17 a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no kstack");
80106031:	83 ec 0c             	sub    $0xc,%esp
80106034:	68 94 6e 10 80       	push   $0x80106e94
80106039:	e8 0a a3 ff ff       	call   80100348 <panic>
    panic("switchuvm: no pgdir");
8010603e:	83 ec 0c             	sub    $0xc,%esp
80106041:	68 a9 6e 10 80       	push   $0x80106ea9
...
80106050:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80106053:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106059:	77 4c                	ja     801060a7 <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
8010605b:	e8 5b c0 ff ff       	call   801020bb <kalloc>
80106060:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106062:	83 ec 04             	sub    $0x4,%esp
80106065:	68 00 10 00 00       	push   $0x1000
8010606a:	6a 00                	push   $0x0
8010606c:	50                   	push   %eax
8010606d:	e8 65 dc ff ff       	call   80103cd7 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106072:	83 c4 08             	add    $0x8,%esp
80106075:	6a 06                	push   $0x6
80106077:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010607d:	50                   	push   %eax
8010607e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106083:	ba 00 00 00 00       	mov    $0x0,%edx
80106088:	8b 45 08             	mov    0x8(%ebp),%eax
8010608b:	e8 cf fc ff ff       	call   80105d5f <mappages>
  memmove(mem, init, sz);
80106090:	83 c4 0c             	add    $0xc,%esp
80106093:	56                   	push   %esi
80106094:	ff 75 0c             	pushl  0xc(%ebp)
80106097:	53                   	push   %ebx
80106098:	e8 b5 dc ff ff       	call   80103d52 <memmove>
}
8010609d:	83 c4 10             	add    $0x10,%esp
801060a0:	8d 65 f8             	lea    -0x8(%ebp),%esp
801060a3:	5b                   	pop    %ebx
801060a4:	5e                   	pop    %esi
801060a5:	5d                   	pop    %ebp
801060a6:	c3                   	ret    
...
801060aa:	68 bd 6e 10 80       	push   $0x80106ebd
...
801060bd:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
801060c0:	f7 45 0c ff 0f 00 00 	testl  $0xfff,0xc(%ebp)
801060c7:	75 07                	jne    801060d0 <loaduvm+0x1c>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
801060c9:	bb 00 00 00 00       	mov    $0x0,%ebx
801060ce:	eb 3c                	jmp    8010610c <loaduvm+0x58>
    panic("loaduvm: addr must be page aligned");
801060d0:	83 ec 0c             	sub    $0xc,%esp
801060d3:	68 78 6f 10 80       	push   $0x80106f78
801060d8:	e8 6b a2 ff ff       	call   80100348 <panic>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801060dd:	83 ec 0c             	sub    $0xc,%esp
801060e0:	68 d7 6e 10 80       	push   $0x80106ed7
...
801060ea:	05 00 00 00 80       	add    $0x80000000,%eax
801060ef:	56                   	push   %esi
801060f0:	89 da                	mov    %ebx,%edx
801060f2:	03 55 14             	add    0x14(%ebp),%edx
801060f5:	52                   	push   %edx
801060f6:	50                   	push   %eax
801060f7:	ff 75 10             	pushl  0x10(%ebp)
801060fa:	e8 74 b6 ff ff       	call   80101773 <readi>
801060ff:	83 c4 10             	add    $0x10,%esp
80106102:	39 f0                	cmp    %esi,%eax
80106104:	75 47                	jne    8010614d <loaduvm+0x99>
  for(i = 0; i < sz; i += PGSIZE){
80106106:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010610c:	39 fb                	cmp    %edi,%ebx
8010610e:	73 30                	jae    80106140 <loaduvm+0x8c>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106110:	89 da                	mov    %ebx,%edx
80106112:	03 55 0c             	add    0xc(%ebp),%edx
80106115:	b9 00 00 00 00       	mov    $0x0,%ecx
8010611a:	8b 45 08             	mov    0x8(%ebp),%eax
8010611d:	e8 cd fb ff ff       	call   80105cef <walkpgdir>
80106122:	85 c0                	test   %eax,%eax
80106124:	74 b7                	je     801060dd <loaduvm+0x29>
    pa = PTE_ADDR(*pte);
80106126:	8b 00                	mov    (%eax),%eax
80106128:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
8010612d:	89 fe                	mov    %edi,%esi
8010612f:	29 de                	sub    %ebx,%esi
80106131:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106137:	76 b1                	jbe    801060ea <loaduvm+0x36>
      n = PGSIZE;
80106139:	be 00 10 00 00       	mov    $0x1000,%esi
8010613e:	eb aa                	jmp    801060ea <loaduvm+0x36>
      return -1;
  }
  return 0;
...
80106152:	eb f1                	jmp    80106145 <loaduvm+0x91>
...
8010615d:	8b 7d 0c             	mov    0xc(%ebp),%edi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
80106160:	39 7d 10             	cmp    %edi,0x10(%ebp)
80106163:	73 11                	jae    80106176 <deallocuvm+0x22>
    return oldsz;

  a = PGROUNDUP(newsz);
80106165:	8b 45 10             	mov    0x10(%ebp),%eax
80106168:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010616e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106174:	eb 19                	jmp    8010618f <deallocuvm+0x3b>
    return oldsz;
80106176:	89 f8                	mov    %edi,%eax
80106178:	eb 64                	jmp    801061de <deallocuvm+0x8a>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010617a:	c1 eb 16             	shr    $0x16,%ebx
8010617d:	83 c3 01             	add    $0x1,%ebx
80106180:	c1 e3 16             	shl    $0x16,%ebx
80106183:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106189:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010618f:	39 fb                	cmp    %edi,%ebx
80106191:	73 48                	jae    801061db <deallocuvm+0x87>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106193:	b9 00 00 00 00       	mov    $0x0,%ecx
80106198:	89 da                	mov    %ebx,%edx
8010619a:	8b 45 08             	mov    0x8(%ebp),%eax
8010619d:	e8 4d fb ff ff       	call   80105cef <walkpgdir>
801061a2:	89 c6                	mov    %eax,%esi
    if(!pte)
801061a4:	85 c0                	test   %eax,%eax
801061a6:	74 d2                	je     8010617a <deallocuvm+0x26>
    else if((*pte & PTE_P) != 0){
801061a8:	8b 00                	mov    (%eax),%eax
801061aa:	a8 01                	test   $0x1,%al
801061ac:	74 db                	je     80106189 <deallocuvm+0x35>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801061ae:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801061b3:	74 19                	je     801061ce <deallocuvm+0x7a>
        panic("kfree");
      char *v = P2V(pa);
...
801061be:	e8 e1 bd ff ff       	call   80101fa4 <kfree>
      *pte = 0;
801061c3:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
801061c9:	83 c4 10             	add    $0x10,%esp
801061cc:	eb bb                	jmp    80106189 <deallocuvm+0x35>
        panic("kfree");
801061ce:	83 ec 0c             	sub    $0xc,%esp
801061d1:	68 06 68 10 80       	push   $0x80106806
801061d6:	e8 6d a1 ff ff       	call   80100348 <panic>
    }
  }
  return newsz;
...
801061ec:	83 ec 1c             	sub    $0x1c,%esp
801061ef:	8b 7d 10             	mov    0x10(%ebp),%edi
  if(newsz >= KERNBASE)
801061f2:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801061f5:	85 ff                	test   %edi,%edi
801061f7:	0f 88 c1 00 00 00    	js     801062be <allocuvm+0xd8>
  if(newsz < oldsz)
801061fd:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106200:	72 5c                	jb     8010625e <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
80106202:	8b 45 0c             	mov    0xc(%ebp),%eax
80106205:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
8010620b:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106211:	39 fb                	cmp    %edi,%ebx
80106213:	0f 83 ac 00 00 00    	jae    801062c5 <allocuvm+0xdf>
    mem = kalloc();
80106219:	e8 9d be ff ff       	call   801020bb <kalloc>
8010621e:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106220:	85 c0                	test   %eax,%eax
80106222:	74 42                	je     80106266 <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
80106224:	83 ec 04             	sub    $0x4,%esp
80106227:	68 00 10 00 00       	push   $0x1000
8010622c:	6a 00                	push   $0x0
8010622e:	50                   	push   %eax
8010622f:	e8 a3 da ff ff       	call   80103cd7 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106234:	83 c4 08             	add    $0x8,%esp
80106237:	6a 06                	push   $0x6
80106239:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010623f:	50                   	push   %eax
80106240:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106245:	89 da                	mov    %ebx,%edx
80106247:	8b 45 08             	mov    0x8(%ebp),%eax
8010624a:	e8 10 fb ff ff       	call   80105d5f <mappages>
8010624f:	83 c4 10             	add    $0x10,%esp
80106252:	85 c0                	test   %eax,%eax
80106254:	78 38                	js     8010628e <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
80106256:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010625c:	eb b3                	jmp    80106211 <allocuvm+0x2b>
    return oldsz;
8010625e:	8b 45 0c             	mov    0xc(%ebp),%eax
80106261:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106264:	eb 5f                	jmp    801062c5 <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
80106266:	83 ec 0c             	sub    $0xc,%esp
80106269:	68 f5 6e 10 80       	push   $0x80106ef5
8010626e:	e8 98 a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106273:	83 c4 0c             	add    $0xc,%esp
80106276:	ff 75 0c             	pushl  0xc(%ebp)
80106279:	57                   	push   %edi
8010627a:	ff 75 08             	pushl  0x8(%ebp)
8010627d:	e8 d2 fe ff ff       	call   80106154 <deallocuvm>
      return 0;
80106282:	83 c4 10             	add    $0x10,%esp
80106285:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
8010628c:	eb 37                	jmp    801062c5 <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
8010628e:	83 ec 0c             	sub    $0xc,%esp
80106291:	68 0d 6f 10 80       	push   $0x80106f0d
80106296:	e8 70 a3 ff ff       	call   8010060b <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
8010629b:	83 c4 0c             	add    $0xc,%esp
8010629e:	ff 75 0c             	pushl  0xc(%ebp)
801062a1:	57                   	push   %edi
801062a2:	ff 75 08             	pushl  0x8(%ebp)
801062a5:	e8 aa fe ff ff       	call   80106154 <deallocuvm>
      kfree(mem);
801062aa:	89 34 24             	mov    %esi,(%esp)
801062ad:	e8 f2 bc ff ff       	call   80101fa4 <kfree>
      return 0;
801062b2:	83 c4 10             	add    $0x10,%esp
801062b5:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
801062bc:	eb 07                	jmp    801062c5 <allocuvm+0xdf>
    return 0;
...
801062d5:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801062d8:	85 f6                	test   %esi,%esi
801062da:	74 1a                	je     801062f6 <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
801062dc:	83 ec 04             	sub    $0x4,%esp
801062df:	6a 00                	push   $0x0
801062e1:	68 00 00 00 80       	push   $0x80000000
801062e6:	56                   	push   %esi
801062e7:	e8 68 fe ff ff       	call   80106154 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801062ec:	83 c4 10             	add    $0x10,%esp
801062ef:	bb 00 00 00 00       	mov    $0x0,%ebx
801062f4:	eb 10                	jmp    80106306 <freevm+0x36>
    panic("freevm: no pgdir");
801062f6:	83 ec 0c             	sub    $0xc,%esp
801062f9:	68 29 6f 10 80       	push   $0x80106f29
801062fe:	e8 45 a0 ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106303:	83 c3 01             	add    $0x1,%ebx
80106306:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
8010630c:	77 1f                	ja     8010632d <freevm+0x5d>
    if(pgdir[i] & PTE_P){
8010630e:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106311:	a8 01                	test   $0x1,%al
80106313:	74 ee                	je     80106303 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106315:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010631a:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010631f:	83 ec 0c             	sub    $0xc,%esp
80106322:	50                   	push   %eax
80106323:	e8 7c bc ff ff       	call   80101fa4 <kfree>
80106328:	83 c4 10             	add    $0x10,%esp
8010632b:	eb d6                	jmp    80106303 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
80106345:	e8 71 bd ff ff       	call   801020bb <kalloc>
8010634a:	89 c6                	mov    %eax,%esi
8010634c:	85 c0                	test   %eax,%eax
8010634e:	74 55                	je     801063a5 <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
80106350:	83 ec 04             	sub    $0x4,%esp
80106353:	68 00 10 00 00       	push   $0x1000
80106358:	6a 00                	push   $0x0
8010635a:	50                   	push   %eax
8010635b:	e8 77 d9 ff ff       	call   80103cd7 <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106360:	83 c4 10             	add    $0x10,%esp
80106363:	bb 20 94 10 80       	mov    $0x80109420,%ebx
80106368:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
8010636e:	73 35                	jae    801063a5 <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
80106370:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106373:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106376:	29 c1                	sub    %eax,%ecx
80106378:	83 ec 08             	sub    $0x8,%esp
8010637b:	ff 73 0c             	pushl  0xc(%ebx)
8010637e:	50                   	push   %eax
8010637f:	8b 13                	mov    (%ebx),%edx
80106381:	89 f0                	mov    %esi,%eax
80106383:	e8 d7 f9 ff ff       	call   80105d5f <mappages>
80106388:	83 c4 10             	add    $0x10,%esp
8010638b:	85 c0                	test   %eax,%eax
8010638d:	78 05                	js     80106394 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010638f:	83 c3 10             	add    $0x10,%ebx
80106392:	eb d4                	jmp    80106368 <setupkvm+0x28>
      freevm(pgdir);
80106394:	83 ec 0c             	sub    $0xc,%esp
80106397:	56                   	push   %esi
80106398:	e8 33 ff ff ff       	call   801062d0 <freevm>
      return 0;
8010639d:	83 c4 10             	add    $0x10,%esp
801063a0:	be 00 00 00 00       	mov    $0x0,%esi
}
801063a5:	89 f0                	mov    %esi,%eax
...
801063b1:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801063b4:	e8 87 ff ff ff       	call   80106340 <setupkvm>
801063b9:	a3 a4 44 11 80       	mov    %eax,0x801144a4
  switchkvm();
801063be:	e8 5e fb ff ff       	call   80105f21 <switchkvm>
}
801063c3:	c9                   	leave  
801063c4:	c3                   	ret    
...
801063d6:	e8 14 f9 ff ff       	call   80105cef <walkpgdir>
  if(pte == 0)
801063db:	85 c0                	test   %eax,%eax
801063dd:	74 05                	je     801063e4 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
801063df:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801063e2:	c9                   	leave  
801063e3:	c3                   	ret    
    panic("clearpteu");
801063e4:	83 ec 0c             	sub    $0xc,%esp
801063e7:	68 3a 6f 10 80       	push   $0x80106f3a
801063ec:	e8 57 9f ff ff       	call   80100348 <panic>
...
801063f7:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
801063fa:	e8 41 ff ff ff       	call   80106340 <setupkvm>
801063ff:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106402:	85 c0                	test   %eax,%eax
80106404:	0f 84 c4 00 00 00    	je     801064ce <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010640a:	bf 00 00 00 00       	mov    $0x0,%edi
8010640f:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106412:	0f 83 b6 00 00 00    	jae    801064ce <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106418:	89 7d e4             	mov    %edi,-0x1c(%ebp)
8010641b:	b9 00 00 00 00       	mov    $0x0,%ecx
80106420:	89 fa                	mov    %edi,%edx
80106422:	8b 45 08             	mov    0x8(%ebp),%eax
80106425:	e8 c5 f8 ff ff       	call   80105cef <walkpgdir>
8010642a:	85 c0                	test   %eax,%eax
8010642c:	74 65                	je     80106493 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
8010642e:	8b 00                	mov    (%eax),%eax
80106430:	a8 01                	test   $0x1,%al
80106432:	74 6c                	je     801064a0 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106434:	89 c6                	mov    %eax,%esi
80106436:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
8010643c:	25 ff 0f 00 00       	and    $0xfff,%eax
80106441:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
80106444:	e8 72 bc ff ff       	call   801020bb <kalloc>
80106449:	89 c3                	mov    %eax,%ebx
8010644b:	85 c0                	test   %eax,%eax
8010644d:	74 6a                	je     801064b9 <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
8010644f:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106455:	83 ec 04             	sub    $0x4,%esp
80106458:	68 00 10 00 00       	push   $0x1000
8010645d:	56                   	push   %esi
8010645e:	50                   	push   %eax
8010645f:	e8 ee d8 ff ff       	call   80103d52 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106464:	83 c4 08             	add    $0x8,%esp
80106467:	ff 75 e0             	pushl  -0x20(%ebp)
8010646a:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106470:	50                   	push   %eax
80106471:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106476:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106479:	8b 45 dc             	mov    -0x24(%ebp),%eax
8010647c:	e8 de f8 ff ff       	call   80105d5f <mappages>
80106481:	83 c4 10             	add    $0x10,%esp
80106484:	85 c0                	test   %eax,%eax
80106486:	78 25                	js     801064ad <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
80106488:	81 c7 00 10 00 00    	add    $0x1000,%edi
8010648e:	e9 7c ff ff ff       	jmp    8010640f <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106493:	83 ec 0c             	sub    $0xc,%esp
80106496:	68 44 6f 10 80       	push   $0x80106f44
8010649b:	e8 a8 9e ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
801064a0:	83 ec 0c             	sub    $0xc,%esp
801064a3:	68 5e 6f 10 80       	push   $0x80106f5e
801064a8:	e8 9b 9e ff ff       	call   80100348 <panic>
      kfree(mem);
801064ad:	83 ec 0c             	sub    $0xc,%esp
801064b0:	53                   	push   %ebx
801064b1:	e8 ee ba ff ff       	call   80101fa4 <kfree>
      goto bad;
...
801064bc:	ff 75 dc             	pushl  -0x24(%ebp)
801064bf:	e8 0c fe ff ff       	call   801062d0 <freevm>
  return 0;
801064c4:	83 c4 10             	add    $0x10,%esp
801064c7:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
...
801064ea:	e8 00 f8 ff ff       	call   80105cef <walkpgdir>
  if((*pte & PTE_P) == 0)
801064ef:	8b 00                	mov    (%eax),%eax
801064f1:	a8 01                	test   $0x1,%al
801064f3:	74 10                	je     80106505 <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
801064f5:	a8 04                	test   $0x4,%al
801064f7:	74 13                	je     8010650c <uva2ka+0x33>
    return 0;
...
8010650a:	eb f7                	jmp    80106503 <uva2ka+0x2a>
    return 0;
8010650c:	b8 00 00 00 00       	mov    $0x0,%eax
80106511:	eb f0                	jmp    80106503 <uva2ka+0x2a>
...
8010651c:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
8010651f:	eb 25                	jmp    80106546 <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106521:	8b 55 0c             	mov    0xc(%ebp),%edx
80106524:	29 f2                	sub    %esi,%edx
80106526:	01 d0                	add    %edx,%eax
80106528:	83 ec 04             	sub    $0x4,%esp
8010652b:	53                   	push   %ebx
8010652c:	ff 75 10             	pushl  0x10(%ebp)
8010652f:	50                   	push   %eax
80106530:	e8 1d d8 ff ff       	call   80103d52 <memmove>
    len -= n;
80106535:	29 df                	sub    %ebx,%edi
    buf += n;
80106537:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
8010653a:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
80106540:	89 45 0c             	mov    %eax,0xc(%ebp)
80106543:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
80106546:	85 ff                	test   %edi,%edi
80106548:	74 2f                	je     80106579 <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
8010654a:	8b 75 0c             	mov    0xc(%ebp),%esi
8010654d:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
80106553:	83 ec 08             	sub    $0x8,%esp
80106556:	56                   	push   %esi
80106557:	ff 75 08             	pushl  0x8(%ebp)
8010655a:	e8 7a ff ff ff       	call   801064d9 <uva2ka>
    if(pa0 == 0)
8010655f:	83 c4 10             	add    $0x10,%esp
80106562:	85 c0                	test   %eax,%eax
80106564:	74 20                	je     80106586 <copyout+0x73>
    n = PGSIZE - (va - va0);
80106566:	89 f3                	mov    %esi,%ebx
80106568:	2b 5d 0c             	sub    0xc(%ebp),%ebx
8010656b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
80106571:	39 df                	cmp    %ebx,%edi
80106573:	73 ac                	jae    80106521 <copyout+0xe>
      n = len;
80106575:	89 fb                	mov    %edi,%ebx
80106577:	eb a8                	jmp    80106521 <copyout+0xe>
  }
  return 0;
80106579:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
8010658b:	eb f1                	jmp    8010657e <copyout+0x6b>
