...
main(int argc, char *argv[])
{
  ...
  2c:	e8 88 02 00 00       	call   2b9 <getpri>
  ...
  37:	74 37                	je     70 <main+0x70>
    ...
    printf(1, "XV6_SCHEDULER\t getpri FAILED to return the correct error return code\n");
...
000002b1 <setpri>:
SYSCALL(setpri)
 2b1:	b8 16 00 00 00       	mov    $0x16,%eax
 2b6:	cd 40                	int    $0x40
 2b8:	c3                   	ret    
...
000002c1 <fork2>:
SYSCALL(fork2)
 2c1:	b8 18 00 00 00       	mov    $0x18,%eax
 2c6:	cd 40                	int    $0x40
 2c8:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32f:	0f b6 92 d0 06 00 00 	movzbl 0x6d0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 46b:	75 28                	jne    495 <printf+0x12a>
          s = "(null)";
 46d:	be c8 06 00 00       	mov    $0x6c8,%esi
...
free(void *ap)
{
 ...
 4e0:	a1 68 09 00 00       	mov    0x968,%eax
 ...
 51c:	89 08                	mov    %ecx,(%eax)
  freep = p;
 51e:	a3 68 09 00 00       	mov    %eax,0x968
}
 523:	5b                   	pop    %ebx
 524:	5e                   	pop    %esi
 525:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 57b:	e8 54 ff ff ff       	call   4d4 <free>
  return freep;
 580:	a1 68 09 00 00       	mov    0x968,%eax
...
malloc(uint nbytes)
{
 ...
 5a4:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5a7:	8b 0d 68 09 00 00    	mov    0x968,%ecx
 ...
 5b3:	eb 4d                	jmp    602 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 5b5:	c7 05 68 09 00 00 6c 	movl   $0x96c,0x968
 5bc:	09 00 00 
 5bf:	c7 05 6c 09 00 00 6c 	movl   $0x96c,0x96c
 5c6:	09 00 00 
    base.s.size = 0;
 5c9:	c7 05 70 09 00 00 00 	movl   $0x0,0x970
 5d0:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5d3:	b9 6c 09 00 00       	mov    $0x96c,%ecx
 ...
 5e6:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5e9:	89 0d 68 09 00 00    	mov    %ecx,0x968
      return (void*)(p + 1);
 ...
 607:	73 d1                	jae    5da <malloc+0x46>
    if(p == freep)
 609:	39 05 68 09 00 00    	cmp    %eax,0x968
